...
primitive STRATIXIII_PRIM_DFFE (Q, ENA, D, CLK, CLRN, PRN, notifier);
   input D;   
   input CLRN;
   input PRN;
   input CLK;
...
primitive STRATIXIII_PRIM_DFFEAS (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
...
primitive STRATIXIII_PRIM_DFFEAS_HIGH (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
    input d,clk,ena,clr,pre,ald,adt,sclr,sload, notifier;
    output q;
    reg q;
    initial
...
module stratixiii_dffe ( Q, CLK, ENA, D, CLRN, PRN );
   input D;
   input CLK;
   input CLRN;
   input PRN;
   ...
   STRATIXIII_PRIM_DFFE ( Q, ENA_ipd, D_ipd, CLK_ipd, CLRN_ipd, PRN_ipd, viol_notifier );
...
module stratixiii_mux21 (MO, A, B, S);
   input A, B, S;
   output MO;
...
module stratixiii_mux41 (MO, IN0, IN1, IN2, IN3, S);
   input IN0;
   input IN1;
   input IN2;
   input IN3;
...
//
// Description : Stratix III LCELL_COMB Verilog simulation model 
//
//------------------------------------------------------------------

// Deactivate the following LEDA rules for stratixiii_lcell_comb.v
...
//------------------------------------------------------------------
//
// Module Name : stratixiii_routing_wire
//
...
endmodule // stratixiii_routing_wire
///////////////////////////////////////////////////////////////////////////////
//
...
`timescale 1ps / 1ps
module stratixiii_lvds_tx_reg (q,
                clk,
                ena,
                d,
                clrn,
...
parameter read_before_write_b = (hw_write_mode_b == "R+W") ? 1'b1 : 1'b0;
 ...
 parameter clock_duty_cycle_dependence = "AUTO";
...
begin
 ...
 // port A
 stratixiii_ram_register aclr__a__mux_register (
        .d(dataout_a_clr),
        .clk(clk_a_core),
        .aclr(1'b0),
        .devclrn(devclrn),
 ...
 // port B
 stratixiii_ram_register aclr__b__mux_register (
        .d(dataout_b_clr),
        .clk(clk_b_core),
        .aclr(1'b0),
        .devclrn(devclrn),
...
stratixiii_ram_register dataout_a_register (
        .d(dataout_a),
        .clk(clk_a_out),
 .aclr(dataout_a_clr),
        .devclrn(devclrn),
...
stratixiii_ram_register dataout_b_register (
        .d( dataout_b ),
        .clk(clk_b_out),
 .aclr(dataout_b_clr),
        .devclrn(devclrn),.devpor(devpor),
...
//------------------------------------------------------------------
//
// Module Name : stratixiii_ff
//
// Description : Stratix III FF Verilog simulation model 
//
//------------------------------------------------------------------
`timescale 1 ps/1 ps
  
module stratixiii_ff (
    d, 
    clk, 
    clrn, 
    aload, 
...
parameter lpm_type = "stratixiii_ff";
...
//------------------------------------------------------------------
//
// Module Name : stratixiii_clkselect
//
// Description : Stratix III CLKSELECT Verilog simulation model 
//
//------------------------------------------------------------------
...
//------------------------------------------------------------------
//
// Module Name : stratixiii_and2
//
// Description : Simulation model for a simple 2-inputs AND gate.
//               This is used for the storing delays for Stratix III CLKENA.
//
//------------------------------------------------------------------

`timescale 1ps / 1ps

module stratixiii_and2 (
                IN1,
                IN2,
                Y
               );
...
//------------------------------------------------------------------
//
// Module Name : stratixiii_ena_reg
//
// Description : Simulation model for a simple DFF.
...
endmodule // stratixiii_ena_reg

//------------------------------------------------------------------
//
// Module Name : stratixiii_clkena
//
// Description : Stratix III CLKENA Verilog simulation model 
//
//------------------------------------------------------------------
...
stratixiii_ena_reg extena_reg1(
                    .clk(!inclk),
                    .ena(1'b1),
                    .d(ena),
                    .clrn(1'b1),
...
stratixiii_ena_reg extena_reg2(
                    .clk(!inclk),
                    .ena(1'b1),
                    .d(cereg1_out),
                    .clrn(1'b1),
...
stratixiii_and2 outclk_and(
                .IN1(inclk),
                .IN2(ena_out),
                .Y(outclk)
                );

stratixiii_and2 enaout_and(
                .IN1(1'b1),
                .IN2(ena_out),
                .Y(enaout)
                );
...
module stratixiii_mlab_cell_pulse_generator (
                                    clk,     
                                    ena,     
                                    pulse,
                                    cycle    
...
//--------------------------------------------------------------------------
// Module Name     : stratixiii_mlab_cell
// Description     : Main RAM module
//--------------------------------------------------------------------------
...
// Write pulse generation
stratixiii_mlab_cell_pulse_generator wpgen_a (
        .clk(~clk_a_in),
        .ena(ena0_reg),
        .pulse(write_pulse),
	.cycle(write_cycle)
...
endmodule // stratixiii_mlab_cell_block

//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    stratixiii_io_ibuf                                 //
//Description:                    Simulation model for Stratix III IO Input Buffer    //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

// Deactivate the following LEDA rules for stratixiii_io_atom.v
// G_521_3B: Use uppercase letters for all parameter names
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    stratixiii_io_obuf                                 //
//Description:                    Simulation model for Stratix III IO Output Buffer   //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    stratixiii_ddio_out                                //
//Description:                    Simulation model for Stratix III DDIO Output        //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    stratixiii_ddio_oe                                 //
//Description:                    Simulation model for Stratix III DDIO OE            //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//Module Name:                    stratixiii_ddio_in                                 
//Description:                    Simulation model for Stratix III DDIO IN            
//                                                                              
////////////////////////////////////////////////////////////////////////////////
...
`timescale 1 ps/1 ps
module stratixiii_mac_register (
                           datain,
                           clk,
                           aclr,
                           sload,
...
//                              1.stratixiii_mac_register.                           //
//                              2.stratixiii_mac_multiplier.                         //
//////////////////////////////////////////////////////////////////////////////////
...
stratixiii_mac_register dataa_input_register (
                                         .datain(dataa),
                                         .clk(dataa_clk),
                                         .aclr(dataa_aclr),
                                         .sload(dataa_sload),
...
stratixiii_mac_register datab_input_register (
                                         .datain(datab),
                                         .clk(datab_clk),
                                         .aclr(datab_aclr),
                                         .sload(datab_sload),
...
stratixiii_mac_register signa_input_register (
                                         .datain(signa),
                                         .clk(signa_clk),
                                         .aclr(signa_aclr),
                                         .sload(signa_sload),
...
stratixiii_mac_register signb_input_register (
                                         .datain(signb),
                                         .clk(signb_clk),
                                         .aclr(signb_aclr),
                                         .sload(signb_sload),
...
stratixiii_mac_register scanouta_input_register (
                                             .datain(dataa_in_reg),
                                             .clk(scanouta_clk),
                                             .aclr(scanouta_aclr),
...
stratixiii_mac_multiplier mac_multiplier (
                                     .dataa(dataa_in_reg),
                                     .datab(datab_in_reg),
                                     .signa(signa_mult),
                                     .signb(signb_mult),
...
//////////////////////////////////////////////////////////////////////////////////////////////////
//  Module Name:             stratixiii_saturation_block                                             //
...
//  Description:             Stratix III rotate and shift Unit.                                       //
//////////////////////////////////////////////////////////////////////////////////////////////////
...
//  Description:             Stratix III carry chain adder Unit.                                      //
//////////////////////////////////////////////////////////////////////////////////////////////////
...
stratixiii_mac_register zeroloopback_input_register (
                                                .datain(zeroloopback),
...
stratixiii_mac_register zeroacc_input_register (
                                           .datain(zeroacc),
                                           .clk(zeroacc_clk_ir),
...
stratixiii_mac_register rotate_input_register (
                                         .datain(rotate),
                                         .clk(rotate_clk_ir),
                                         .aclr(rotate_aclr_ir),
...
stratixiii_mac_register shiftright_input_register (
                                              .datain(shiftright),
...
stratixiii_mac_register round_input_register (
                                         .datain(round),
                                         .clk(round_clk_ir),
                                         .aclr(round_aclr_ir),
...
stratixiii_mac_register saturate_input_register (
                                            .datain(saturate),
                                            .clk(saturate_clk_ir),
...
stratixiii_mac_register roundchainout_input_register (
...
stratixiii_mac_register saturatechainout_input_register (
...
//Instantiate the First level adder interface and sign extension block
 stratixiii_fsa_isse fsa_interface(
                              .dataa(dataa),
                              .datab(datab),
                              .datac(datac),
                              .datad(datad),
...
stratixiii_first_stage_add_sub fsaunit0(
                                  .dataa(dataa_fsa_in),
                                  .datab(datab_fsa_in),
                                  .sign(sign),
                                  .operation(operation),
...
stratixiii_first_stage_add_sub fsaunit1(
                                  .dataa(datac_fsa_in),
                                  .datab(datad_fsa_in),
                                  .sign(sign),
                                  .operation(operation),
...
stratixiii_mac_register zeroloopback_pipeline_register (
...
stratixiii_mac_register zeroacc_pipeline_register (
...
stratixiii_mac_register signa_pipeline_register (
                                             .datain(signa_in_reg),
                                             .clk(signa_clk_pip),
                                             .aclr(signa_aclr_pip),
...
stratixiii_mac_register signb_pipeline_register (
                                             .datain(signb_in_reg),
                                             .clk(signb_clk_pip),
                                             .aclr(signb_aclr_pip),
...
stratixiii_mac_register rotate_pipeline_register (
...
stratixiii_mac_register shiftright_pipeline_register (
...
stratixiii_mac_register round_pipeline_register (
                                             .datain(round_in_reg),
                                             .clk(round_clk_pip),
                                             .aclr(round_aclr_pip),
...
stratixiii_mac_register saturate_pipeline_register (
...
stratixiii_mac_register roundchainout_pipeline_register (
...
stratixiii_mac_register saturatechainout_pipeline_register (
...
stratixiii_mac_register fsa0_pipeline_register (
...
stratixiii_mac_register fsa1_pipeline_register (
                                           .datain(dataout_fsa1),
                                           .clk(fsa1_clk_pip),
                                           .aclr(fsa1_aclr_pip),
...
stratixiii_second_stage_add_accum ssa_unit(
                                      .dataa(fsa0_pip_reg),
                                      .datab(fsa1_pip_reg),
...
stratixiii_round_saturate_block rs_block(
                                   .datain(rs_datain),
                                   .round(round_pip_reg),
...
stratixiii_mac_register zeroloopback_output_register (
...
stratixiii_mac_register zerochainout_output_register (
                                                 .datain(zerochainout),
...
stratixiii_mac_register rs_dataout_output_register (
...
stratixiii_mac_register rs_saturation_overflow_output_register (
...
stratixiii_mac_register rotate_output_register (
...
stratixiii_mac_register shiftright_output_register (
...
stratixiii_mac_register roundchainout_output_register (
...
stratixiii_mac_register saturatechainout_output_register (
...
stratixiii_mac_register coa_rs_saturation_overflow_register (
...
stratixiii_mac_register coa_rs_saturationchainout_overflow_register (
...
stratixiii_mac_register coa_rs_dataout_register (
...
stratixiii_rotate_shift_block shift_rot_unit(
...
// begin_ddr
//-----------------------------------------------------------------------------
// Module Name: stratixiii_ddr_gray_decoder
...
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
module stratixiii_ddr_delay_chain_s (
        clk, 
        delayctrlin, 
        phasectrlin, 
        delayed_clkout
...
stratixiii_ddr_gray_decoder m_delayctrl_in_dec(delayctrlin_in, delayctrl_bin);
...
//-----------------------------------------------------------------------------
//
// Module Name : stratixiii_dll
//
// Description : Stratix III Delay Locked Loop 
//               Verilog simulation model 
//
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
  
module stratixiii_dll (
    clk, 
    aload, 
    upndnin, 
    upndninclkena, 
...
parameter dual_phase_comparators = "true"; // new in stratixiii

parameter lpm_type           = "stratixiii_dll";
...
wire       jc_upndn_in;
wire       jc_aload_in;
wire       jc_clkena_in;  // new in stratixiii
...
// phase comparator
wire       pc_lock;      // new in stratixiii
wire       pc_upndn_out;
...
reg        pc_reg_upndn;
integer    pc_delay;
reg        pc_lock_reg;   // new in stratixiii
integer    pc_comp_range; // new in stratixiii
...
// Delay Setting Control Counter ----------------------------------------------
    ...
    assign dc_upndnclkena_in = (para_use_upndninclkena === 1'b1) ? upndninclkena : 
                               ...
                               (dual_phase_comparators == "true") ? ~pc_lock : 1'b1;  // new in stratixiii
...
endmodule    // stratixiii_dll

//-----------------------------------------------------------------------------
//
// Module Name : stratixiii_offset_ctrl
//
// Description : Stratix III Delay Locked Loop Offset Control 
//               Verilog simulation model 
//
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
  
module stratixiii_dll_offset_ctrl (
	    clk, 
	    aload, 
	    offsetdelayctrlin, 
	    offset, 
...
parameter lpm_type           = "stratixiii_dll_offset_ctrl";
...
// TCO DELAYS, IO PATH and SETUP-HOLD CHECKS
// These timing paths existed from StratixII, currently not modeled in stratixiii
specify
...
begin
   ...
   assign dr_offsettest_out = (use_offset == "false") ? para_static_offset[5:0] : offset_in;
    ...
    // gray decoder
    stratixiii_ddr_gray_decoder mdr_delayctrl_in_dec(dr_delayctrl_in_gray, dr_delayctrl_in_bin);
    stratixiii_ddr_gray_decoder mdr_offset_in_dec(dr_offset_in_gray, dr_offset_in_bin);
    stratixiii_ddr_gray_decoder mpara_static_offset_dec(para_static_offset_gray, para_static_offset_bin);
...
endmodule    // stratixiii_offset_ctrl

 //-----------------------------------------------------------------------------
 //
 // Module Name : stratixiii_dqs_delay_chain
 //
 // Description : Stratix III DQS Delay Chain (within DQS I/O) 
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
   
 module stratixiii_dqs_delay_chain (
 	    dqsin, 
 	    delayctrlin, 
 	    offsetctrlin, 
 	    dqsupdateen, 
 ...
 parameter sim_high_buffer_intrinsic_delay = 175;
 parameter sim_buffer_delay_increment      = 10;
 parameter lpm_type           = "stratixiii_dqs_delay_chain";
 ...
 // decode
 stratixiii_ddr_gray_decoder m_delayctrl_in_dec (delayctrl_reg_mux,  delayctrl_bin);
 stratixiii_ddr_gray_decoder m_offsetctrl_in_dec(offsetctrl_reg_mux, offsetctrl_bin);
 ...
 endmodule    // stratixiii_dqs_delay_chain
 
 
//-----------------------------------------------------------------------------
//
// Module Name : stratixiii_dqs_enable
//
// Description : Stratix III DQS Enable 
//               Verilog simulation model 
//
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
  
module stratixiii_dqs_enable (
	    dqsin, 
	    dqsenable,
	    devclrn, 
	    devpor,
...
parameter lpm_type = "stratixiii_dqs_enable";
...
pmos (dqsbusout, tmp_dqsbusout, 1'b0);
...
endmodule    // stratixiii_dqs_enable


 //-----------------------------------------------------------------------------
 //
 // Module Name : stratixiii_dqs_enable_ctrl
 //
 // Description : Stratix III DQS Enable Control
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
   
 module stratixiii_dqs_enable_ctrl (
 	    dqsenablein, 
 	    clk, 
 	    delayctrlin, 
 	    phasectrlin,
 ...
 parameter lpm_type = "stratixiii_dqs_enable_ctrl";
 ...
 // delay chain
 stratixiii_ddr_delay_chain_s m_delay_chain(
                         .clk(clk_in), 
 ...
 stratixiii_ddr_io_reg  dqsenablein_reg(
                       .d(dqsenablein_in), 
                       .clk(clk_in), 
                       .ena(1'b1), 
                       .clrn(1'b1), 
 ...
 stratixiii_ddr_io_reg  dqsenable_transfer_reg(
                       .d(dqsenablein_reg_q), 
                       .clk(~delayed_clk), 
                       .ena(1'b1), 
                       .clrn(1'b1), 
 ...
 stratixiii_ddr_io_reg  dqsenableout_reg(
 ...
 stratixiii_ddr_io_reg  dqsenableout_extend_reg(
 ...
 endmodule    // stratixiii_dqs_enable_ctrl
 
 
 //-----------------------------------------------------------------------------
 //
 // Module Name : stratixiii_delay_chain
 //
 // Description : Stratix III Delay Chain (dynamic adjustable delay chain) 
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
 ...
 assign dataout = tmp_dataout;
 ...
 endmodule    // stratixiii_delay_chain
 
 
  //-----------------------------------------------------------------------------
  //
  // Module Name : stratixiii_io_clock_divider
  //
  // Description : Stratix III I/O Clock Divider 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
    
  module stratixiii_io_clock_divider (
          clk, 
          phaseselect, 
          delayctrlin, 
          phasectrlin,
  ...
  parameter lpm_type = "stratixiii_io_clock_divider";
 ...
 // LOCAL_PARAMETERS_END
  ...
  endmodule    // stratixiii_io_clock_divider
  
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : stratixiii_output_phase_alignment
  //
  ...
  module stratixiii_output_phase_alignment (
      datain,
      clk,
      delayctrlin,
      phasectrlin,
  ...
  parameter lpm_type = "stratixiii_output_phase_alignment";
 ...
 // LOCAL_PARAMETERS_END
  ...
  stratixiii_ddr_delay_chain_s m_clk_in_delay_chain(
                          .clk(clk_in), 
                          .delayctrlin(delayctrlin_in), 
                          .phasectrlin(phasectrlin_in), 
  ...
  // Datain Register
  stratixiii_ddr_io_reg  datain_reg(
                        .d(datain_in[0]), 
                        .clk(clk_in_mux), 
                        .ena(1'b1), 
                        .clrn(clrn_in_r), 
  ...
  stratixiii_ddr_io_reg  ddio_datain_reg(
                        .d(datain_in[1]), 
                        .clk(clk_in_mux), 
                        .ena(1'b1), 
                        .clrn(clrn_in_r), 
  ...
  stratixiii_ddr_io_reg  cycledelay_reg(
                        .d(datain_q), 
                        .clk(clk_in_mux), 
                        .ena(1'b1), 
                        .clrn(clrn_in_r), 
  ...
  stratixiii_ddr_io_reg  ddio_cycledelay_reg(
                        .d(ddio_datain_q), 
                        .clk(clk_in_mux), 
                        .ena(1'b1), 
                        .clrn(clrn_in_r), 
  ...
  stratixiii_ddr_io_reg  transferdelay_reg(
 ...
 // Duty Cycle Delay
  ...
  stratixiii_ddr_io_reg  dlyclk_reg(
                        .d(dlyclk_d), 
                        .clk(dlyclk_clk), 
  ...
  // transfer delay is implemented with negative register in rev1.26 
  stratixiii_ddr_io_reg  ddio_transferdelay_reg(
  ...
  // Output Register clocked by phasectrl_clk
  stratixiii_ddr_io_reg  ddio_dlyclk_reg(
                        .d(ddio_dlyclk_d), 
                        .clk(dlyclk_clk), 
                        .ena(dlyclk_clkena_in), 
                        .clrn(clrn_in_r), 
  ...
  stratixiii_ddr_io_reg  dlyclk_extended_reg(
                        .d(dlyclk_q), 
  ...
  endmodule    // stratixiii_output_phase_alignment
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : stratixiii_input_phase_alignment
  //
  ...
  module stratixiii_input_phase_alignment (
      datain,
      clk,
      delayctrlin,
      phasectrlin,
  ...
  parameter lpm_type = "stratixiii_input_phase_alignment";
 ...
 // LOCAL_PARAMETERS_END
  ...
  stratixiii_ddr_io_reg  transfer_reg(
  ...
  endmodule    // stratixiii_input_phase_alignment
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : stratixiii_half_rate_input
  //
  // Description : Stratix III half rate input 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
    
  module stratixiii_half_rate_input (
  	datain,
  	directin,
  	clk,
  	areset,
  ...
  parameter lpm_type = "stratixiii_half_rate_input";
  ...
  // datain_1 - L (n)  
  stratixiii_ddr_io_reg  reg1_l_n(
                        .d(datain_in[1]), 
                        .clk(neg_clk_in), 
                        .ena(1'b1), 
                        .clrn(1'b1), 
  ...
  // datain_0 - L (n)  
  stratixiii_ddr_io_reg  reg0_l_n(
                        .d(datain_in[0]), 
                        .clk(neg_clk_in), 
                        .ena(1'b1), 
                        .clrn(1'b1), 
  ...
  endmodule    // stratixiii_half_rate_input
  
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : stratixiii_io_config
  //
  // Description : Stratix III I/O Configuration Register 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
    
  module stratixiii_io_config (
  	datain,
  	clk,
  	ena,
  	update,
  ...
  parameter lpm_type = "stratixiii_io_config";
  ...
  endmodule    // stratixiii_io_config
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : stratixiii_dqs_config
  //
  // Description : Stratix III DQS Configuration Register 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
    
  module stratixiii_dqs_config (
  	datain,
  	clk,
  	ena,
  	update,
  ...
  parameter enhanced_mode = "false";
  parameter lpm_type = "stratixiii_dqs_config";
  ...
  endmodule    // stratixiii_dqs_config
...
parameter STRATIXIII_RTOCT_WAIT         = 5'b00000;
...
parameter STRATIXIII_RTOCT_INC_PN       = 5'b01000;
parameter STRATIXIII_RTOCT_DEC_PN       = 5'b01001;
parameter STRATIXIII_RTOCT_INC_P        = 5'b01010;
parameter STRATIXIII_RTOCT_DEC_P        = 5'b01011;
parameter STRATIXIII_RTOCT_INC_N        = 5'b01100;
parameter STRATIXIII_RTOCT_DEC_N        = 5'b01101;
parameter STRATIXIII_RTOCT_SWITCH_REG   = 5'b10001;
parameter STRATIXIII_RTOCT_DONE         = 5'b11111;
...
begin
    ...
    STRATIXIII_RTOCT_INC_P,STRATIXIII_RTOCT_DEC_P,STRATIXIII_RTOCT_INC_N,STRATIXIII_RTOCT_DEC_N :
...
// clk divider ----------------------------------------------------------------
stratixiii_termination_aux_clock_div m_gen_calclk (
    .clk(usr_clk), 
...
endmodule    // stratixiii_termination_logic
//--------------------------------------------------------------------------
...
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : stratixiii_m_cntr
//
// Description : Timing simulation model for the M counter. This is the
//               loop feedback counter for the STRATIXIII PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // stratixiii_m_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : stratixiii_n_cntr
//
// Description : Timing simulation model for the N counter. This is the
//               input clock divide counter for the STRATIXIII PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // stratixiii_n_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : stratixiii_scale_cntr
//
// Description : Timing simulation model for the output scale-down counters.
//               This is a common model for the C0-C9
//               output counters of the STRATIXIII PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // stratixiii_scale_cntr

//BEGIN MF PORTING DELETE
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : stratixiii_pll_reg
//
// Description : Simulation model for a simple DFF.
...
// Determine the inclk1 frequency
    ...
    stratixiii_m_cntr m1 (.clk(inclk_m),
    ...
    stratixiii_n_cntr n1 (.clk(inclk_n),
                        .reset(areset),
                        .cout(refclk),
                        .modulus(n_val[0]));
...
always @(vco_out)
    ...
    stratixiii_scale_cntr c0 (.clk(inclk_c0),
                            .reset(areset  || stop_vco),
                            .cout(c0_clk),
                            .high(c_high_val[0]),
                            .low(c_low_val[0]),
    ...
    stratixiii_scale_cntr c1 (.clk(inclk_c1),
                            .reset(areset || stop_vco),
                            .cout(c1_clk),
                            .high(c_high_val[1]),
                            .low(c_low_val[1]),
    ...
    stratixiii_scale_cntr c2 (.clk(inclk_c2),
                            .reset(areset || stop_vco),
                            .cout(c2_clk),
                            .high(c_high_val[2]),
                            .low(c_low_val[2]),
    ...
    stratixiii_scale_cntr c3 (.clk(inclk_c3),
                            .reset(areset  || stop_vco),
                            .cout(c3_clk),
                            .high(c_high_val[3]),
                            .low(c_low_val[3]),
    ...
    stratixiii_scale_cntr c4 (.clk(inclk_c4),
                            .reset(areset || stop_vco),
                            .cout(c4_clk),
                            .high(c_high_val[4]),
                            .low(c_low_val[4]),
    ...
    stratixiii_scale_cntr c5 (.clk(inclk_c5),
                            .reset(areset  || stop_vco),
                            .cout(c5_clk),
                            .high(c_high_val[5]),
                            .low(c_low_val[5]),
    ...
    stratixiii_scale_cntr c6 (.clk(inclk_c6),
                            .reset(areset  || stop_vco),
                            .cout(c6_clk),
                            .high(c_high_val[6]),
                            .low(c_low_val[6]),
    ...
    stratixiii_scale_cntr c7 (.clk(inclk_c7),
                            .reset(areset  || stop_vco),
                            .cout(c7_clk),
                            .high(c_high_val[7]),
                            .low(c_low_val[7]),
    ...
    stratixiii_scale_cntr c8 (.clk(inclk_c8),
                            .reset(areset || stop_vco),
                            .cout(c8_clk),
                            .high(c_high_val[8]),
                            .low(c_low_val[8]),
    ...
    stratixiii_scale_cntr c9 (.clk(inclk_c9),
                            .reset(areset  || stop_vco),
                            .cout(c9_clk),
                            .high(c_high_val[9]),
                            .low(c_low_val[9]),
...
//
// Description : Stratix III ASMIBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
...
endmodule  // stratixiii_asmiblock
//---------------------------------------------------------------------
//
// Module Name : stratixiii_tsdblock
//
// Description : Stratix III TSDBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
...
module stratixiii_lvds_rx_fifo (
    ...
    stratixiii_lvds_rx_fifo_sync_ram  s_fifo_ram (
                                             .clk(wclk),
                                             .datain(ram_datain),
...
endmodule // stratixiii_lvds_rx_fifo
...
`timescale 1 ps/1 ps
module stratixiii_lvds_rx_bitslip (
                              clk0,
                              bslipcntl,
                              bsliprst,
                              datain,
    ...
    stratixiii_lvds_reg bslipcntlreg (
                                .d(bslipcntl),
                                .clk(clk0),
                                .ena(1'b1),
                                .clrn(!bsliprst),
...
stratixiii_lvds_reg dataoutreg (
...
endmodule // stratixiii_lvds_rx_bitslip
...
endmodule //stratixiii_lvds_rx_deser
...
endmodule //stratixiii_lvds_rx_parallel_reg
...
module stratixiii_dpa_block(clkin,
                dpareset,
                dpahold,
                datain,
                clkout,
...
stratixiii_dpa_retime_block data_clock_retime(
                                        .clkin(clkin),
                                        .datain(datain),
                                        .reset(dpareset),
                                        .clk0(clk0_tmp),
...
//               4) stratixiii_lvds_rx_deser
//               5) stratixiii_lvds_rx_parallel_reg
//               6) stratixiii_select_ini_phase_dpaclk
//               7)stratixiii_dpa_block
//               8) stratixiii_pclk_divider
//
//
///////////////////////////////////////////////////////////////////////////////
...
// SIMULATION_ONLY_PARAMETERS_END
   ...
   stratixiii_select_ini_phase_dpaclk ini_clk_phase_select(
                                                     .clkin(clk0),
 ...
 assign   ini_phase_select_enable = (enable_dpa_initial_phase_selection == "on") ? 1'b1 : 1'b0;
    ...
    stratixiii_dpa_block dpa_circuit(
                                .clkin(ini_dpa_clk),
                                .dpareset(dpa_rst),
                                .dpahold(dpahold),
                                .datain(dpareg1_out),
...
assign dpa_rst = ((enable_soft_cdr == "on")|| (enable_dpa == "on")) ? dpareset : 1'b0;
 ...
 stratixiii_pclk_divider  clk_forward(
                                 .clkin(dpa_clk),
                                 .lloaden(lloaden),
...
// FIFO
    stratixiii_lvds_rx_fifo    s_fifo (
                                  .wclk(dpa_clk),
                                  .rclk(fifo_rclk),
                                  .fiforst(fifo_reset),
                                  .dparst(dpa_rst),
...
// BIT SLIP
    stratixiii_lvds_rx_bitslip    s_bslip (
                                      .clk0(s_bitslip_clk),
                                      .bslipcntl(bitslip),
    ...
    // DESERIALISER
    stratixiii_lvds_reg rxload_reg (
                                .d(loaden),
                                .clk(s_bitslip_clk),
                                .ena(1'b1),
                                .clrn(1'b1),
    ...
    stratixiii_lvds_rx_deser    s_deser (
                                    .clk(s_bitslip_clk),
                                    .datain(slip_dataout),
                                    .devclrn(devclrn),
                                    .devpor(devpor),
    ...
    stratixiii_lvds_rx_parallel_reg  output_reg  (
                                             .clk(s_bitslip_clk),
                                             .enable(rxload),
...
// Deactivate the following LEDA rules for stratixiii_pseudo_diff_atom.v
// G_521_3B: Use uppercase letters for all parameter names
// leda G_521_3_B off
...
// -----------------------------------------------------------
//
// Module Name : stratixiii_bias_logic
//
...
endmodule // stratixiii_bias_logic

// -----------------------------------------------------------
//
// Module Name : stratixiii_bias_generator
//
...
endmodule // stratixiii_bias_generator
...
stratixiii_bias_logic logic_block (
                             .clk(clk),
                             .shiftnld(shiftnld),
                             .captnupdt(captnupdt),
...
stratixiii_bias_generator bias_generator (
                                    .din(din),
                                    .mainclk(mainclk_wire),
                                    .updateclk(updateclk_wire),
                                    .capture(capture_wire),
...
endmodule // stratixiii_bias_block
