...
//input and output port declaration
	...
	arriav_hssi_8g_pcs_aggregate_encrypted 
	#(
	...
	arriav_hssi_8g_pcs_aggregate_encrypted_inst	(
...
//input and output port declaration
	...
	arriav_hssi_8g_rx_pcs_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_8g_rx_pcs_encrypted_inst	(
		.a1a2size(a1a2size),
...
//input and output port declaration
	...
	arriav_hssi_8g_tx_pcs_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_8g_tx_pcs_encrypted_inst	(
		.dispcbyte(dispcbyte),
...
//input and output port declaration
	...
	arriav_hssi_common_pcs_pma_interface_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_common_pcs_pma_interface_encrypted_inst	(
...
//input and output port declaration
	...
	arriav_hssi_common_pld_pcs_interface_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_common_pld_pcs_interface_encrypted_inst	(
...
//input and output port declaration
	...
	arriav_hssi_pipe_gen1_2_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_pipe_gen1_2_encrypted_inst	(
		.pcieswitch(pcieswitch),
		.piperxclk(piperxclk),
		.pipetxclk(pipetxclk),
		.polinvrx(polinvrx),
...
//input and output port declaration
	...
	arriav_hssi_pma_aux_encrypted_inst	(
		.calpdb(calpdb),
		.calclk(calclk),
		.testcntl(testcntl),
		.refiqclk(refiqclk),
...
//input and output port declaration
	...
	arriav_hssi_pma_int_encrypted_inst	(
		.bslip(bslip),
		.bslipo(bslipo),
		.ccrurstb(ccrurstb),
...
//input and output port declaration
	...
	arriav_hssi_pma_rx_buf_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_pma_rx_buf_encrypted_inst	(
		.ck0sigdet(ck0sigdet),
		.lpbkp(lpbkp),
		.rdlpbkp(rdlpbkp),
		.rstn(rstn),
...
//input and output port declaration
	...
	arriav_hssi_pma_rx_deser_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_pma_rx_deser_encrypted_inst	(
		.bslip(bslip),
		.clkdivrx(clkdivrx),
		.deven(deven),
		.dodd(dodd),
...
//input and output port declaration
	...
	arriav_hssi_pma_tx_buf_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_pma_tx_buf_encrypted_inst	(
		.rxdetclk(rxdetclk),
		.txdetrx(txdetrx),
		.txelecidl(txelecidl),
		.datain(datain),
...
//input and output port declaration
	...
	arriav_hssi_pma_tx_cgb_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_pma_tx_cgb_encrypted_inst	(
		.clkbcdr1b(clkbcdr1b),
		.clkbcdr1t(clkbcdr1t),
...
//input and output port declaration
	...
	arriav_hssi_pma_tx_ser_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_pma_tx_ser_encrypted_inst	(
		.cpulse(cpulse),
		.datain(datain),
		.hfclkn(hfclkn),
		.hfclk(hfclk),
...
module    arriav_hssi_pma_cdr_refclk_select_mux    (
    ...
    arriav_hssi_pma_cdr_refclk_select_mux_encrypted inst (
        .calclk(calclk),
...
//input and output port declaration
	...
	arriav_hssi_rx_pcs_pma_interface_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_rx_pcs_pma_interface_encrypted_inst	(
...
//input and output port declaration
	...
	arriav_hssi_rx_pld_pcs_interface_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_rx_pld_pcs_interface_encrypted_inst	(
		.emsipenablediocsrrdydly(emsipenablediocsrrdydly),
...
//input and output port declaration
	...
	arriav_hssi_tx_pcs_pma_interface_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_tx_pcs_pma_interface_encrypted_inst	(
		.datainfrom8gpcs(datainfrom8gpcs),
...
//input and output port declaration
	...
	arriav_hssi_tx_pld_pcs_interface_encrypted 
	#(
		.enable_debug_info(enable_debug_info),
	...
	arriav_hssi_tx_pld_pcs_interface_encrypted_inst	(
		.emsipenablediocsrrdydly(emsipenablediocsrrdydly),
		.emsiptxin(emsiptxin),
...
//    arriav_hssi_refclk_divider atom.
//
//  Special Notes:
...
initial begin
  ...
  if (enabled != "false")
    $display("[arriav_hssi_refclk_divider] - ERROR! - Parameter \"enabled\" does not support value $s", enabled);
end
...
(
	...
	arriav_channel_pll_encrypted_inst	(
