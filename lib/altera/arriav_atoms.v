...
primitive ARRIAV_PRIM_DFFE (Q, ENA, D, CLK, CLRN, PRN, notifier);
   input D;   
   input CLRN;
   input PRN;
   input CLK;
...
primitive ARRIAV_PRIM_DFFEAS (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
...
primitive ARRIAV_PRIM_DFFEAS_HIGH (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
    input d,clk,ena,clr,pre,ald,adt,sclr,sload, notifier;
    output q;
    reg q;
    initial
...
module arriav_dffe ( Q, CLK, ENA, D, CLRN, PRN );
   input D;
   input CLK;
   input CLRN;
   input PRN;
   ...
   ARRIAV_PRIM_DFFE ( Q, ENA_ipd, D_ipd, CLK_ipd, CLRN_ipd, PRN_ipd, viol_notifier );
...
module arriav_mux41 (MO, IN0, IN1, IN2, IN3, S);
   input IN0;
   input IN1;
   input IN2;
   input IN3;
...
module arriav_b17mux21 (MO, A, B, S);
   input [16:0] A, B;
   input 	S;
   output [16:0] MO; 
...
module arriav_b5mux21 (MO, A, B, S);
   input [4:0] A, B;
   input       S;
   output [4:0] MO; 
...
//------------------------------------------------------------------
//
// Module Name : arriav_ff
//
// Description : ARRIAV FF Verilog simulation model 
//
//------------------------------------------------------------------
`timescale 1 ps/1 ps
...
//------------------------------------------------------------------
//
// Module Name : arriav_lcell_comb
//
// Description : ARRIAV LCELL_COMB Verilog simulation model 
//
//------------------------------------------------------------------

// Deactivate the following LEDA rules for arriav_lcell_comb.v
...
parameter lpm_type = "arriav_lcell_comb";
...
//--------------------------------------------------------------------------
// Module Name     : arriav_ram_block
// Description     : Main RAM module
//--------------------------------------------------------------------------

module arriav_ram_block
    (
     portadatain,
     portaaddr,
     portawe,
...
//--------------------------------------------------------------------------
// Module Name     : arriav_mlab_cell
// Description     : Main RAM module
//--------------------------------------------------------------------------

`timescale 1 ps/1 ps

module arriav_mlab_cell
    (
     portadatain,
     portaaddr, 
     portabyteenamasks, 
...
parameter lpm_type = "arriav_mlab_cell";
parameter lpm_hint = "true";
...
endmodule // arriav_mlab_cell
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriav_io_ibuf                                 //
//Description:                    Simulation model for ARRIAV IO Input Buffer    //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

// Deactivate the following LEDA rules for arriav_io_atom.v
// G_521_3B: Use uppercase letters for all parameter names
...
parameter lpm_type = "arriav_io_ibuf";
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriav_io_obuf                                 //
//Description:                    Simulation model for ARRIAV IO Output Buffer   //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

module arriav_io_obuf (
                      i,
                      oe,
                      dynamicterminationcontrol,      
...
parameter lpm_type = "arriav_io_obuf";
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriav_ddio_out                                //
//Description:                    Simulation model for ARRIAV DDIO Output        //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

module arriav_ddio_out (
                        datainlo,
                        datainhi,
                        clk,
                        clkhi,
...
parameter lpm_type = "arriav_ddio_out";
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriav_ddio_oe                                 //
//Description:                    Simulation model for ARRIAV DDIO OE            //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
module arriav_ddio_oe (
                       oe,
		       octreadcontrol,	
                       clk,
                       ena,
...
parameter async_mode = "none";
parameter sync_mode = "none";
parameter lpm_type = "arriav_ddio_oe";
...
////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriav_ddio_in                                 
//Description:                    Simulation model for ARRIAV DDIO IN            
//                                                                              
////////////////////////////////////////////////////////////////////////////////
                                                                                
                                                                                
module arriav_ddio_in (                                                          
                      datain,                                                   
                      clk,                                                      
                      clkn,                                                     
                      ena,                                                      
...
parameter lpm_type = "arriav_ddio_in";                                           
...
module arriav_io_pad ( 
		      padin, 
                      padout
	            );

parameter lpm_type = "arriav_io_pad";
//INPUT PORTS
...
parameter lpm_type = "arriav_pseudo_diff_out";
...
endmodule // arriav_bias_logic

// -----------------------------------------------------------
//
// Module Name : arriav_bias_generator
//
// Description : ARRIAV Bias Generator Verilog simulation model
//
// -----------------------------------------------------------

`timescale 1 ps/1 ps

module arriav_bias_generator (
    din,
    mainclk,
    updateclk,
    capture,
...
endmodule // arriav_bias_generator

// -----------------------------------------------------------
//
// Module Name : arriav_bias_block
//
// Description : ARRIAV Bias Block Verilog simulation model
//
// -----------------------------------------------------------

`timescale 1 ps/1 ps

module arriav_bias_block(
			clk,
			shiftnld,
			captnupdt,
			din,
...
parameter lpm_type = "arriav_bias_block";
...
arriav_bias_generator bias_generator (
                                    .din(din),
                                    .mainclk(mainclk_wire),
                                    .updateclk(updateclk_wire),
                                    .capture(capture_wire),
...
endmodule // arriav_bias_block

`timescale 1 ps/1 ps

module arriav_clk_phase_select (    
    clkin,
    phasectrlin,
    phaseinvertctrl,
    dqsin,
    ...
    arriav_clk_phase_select_encrypted inst (
        .clkin(clkin),
...
endmodule //arriav_clk_phase_select

`timescale 1 ps/1 ps

module arriav_clkena    (
    inclk,
    ena,
    enaout,
    outclk);
...
endmodule //arriav_clkena

`timescale 1 ps/1 ps

module arriav_clkselect    (
    inclk,
    clkselect,
    outclk);

// leda G_521_3_B off
    parameter    lpm_type    =    "arriav_clkselect";
...
// leda G_521_3_B on
    ...
    arriav_clkselect_encrypted inst (
        .inclk(inclk),
        .clkselect(clkselect),
        .outclk(outclk) );
    defparam inst.lpm_type = lpm_type;
...
endmodule //arriav_clkselect

`timescale 1 ps/1 ps

module arriav_delay_chain (
    datain,
    delayctrlin,
    dataout);
    ...
    parameter  lpm_type = "arriav_delay_chain";

    input  datain;
    input  [4:0] delayctrlin;
    output dataout;

    arriav_delay_chain_encrypted inst (
        .datain(datain),
...
endmodule //arriav_delay_chain

`timescale 1 ps/1 ps

module    arriav_dll_offset_ctrl    (
    clk,
    offsetdelayctrlin,
    offset,
    addnsub,
    ...
    arriav_dll_offset_ctrl_encrypted inst (
        .clk(clk),
...
endmodule //arriav_dll_offset_ctrl
...
endmodule //arriav_dll

`timescale 1 ps/1 ps

module arriav_dqs_config (
    datain,
    clk,
    ena,
    update,
    ...
    parameter    lpm_type    =    "arriav_dqs_config";
    ...
    arriav_dqs_config_encrypted inst (
        .datain(datain),
        .clk(clk),
        .ena(ena),
        .update(update),
...
endmodule //arriav_dqs_config

`timescale 1 ps/1 ps

module arriav_dqs_delay_chain (
    dqsin,
    dqsenable, 
    dqsdisablen, 
    delayctrlin,
    ...
    arriav_dqs_delay_chain_encrypted inst (
        .dqsin(dqsin),
        .dqsenable(dqsenable),
...
endmodule //arriav_dqs_delay_chain

`timescale 1 ps/1 ps

module arriav_dqs_enable_ctrl (
    rstn,
    dqsenablein,
    zerophaseclk,
    enaphasetransferreg,
    ...
    arriav_dqs_enable_ctrl_encrypted inst (
        .rstn(rstn),
...
endmodule //arriav_dqs_enable_ctrl

`timescale 1 ps/1 ps

module    arriav_duty_cycle_adjustment    (
    clkin,
    delaymode,
    delayctrlin,
    clkout);
    ...
    parameter    lpm_type    =    "arriav_duty_cycle_adjustment";
    ...
    arriav_duty_cycle_adjustment_encrypted inst (
        .clkin(clkin),
        .delaymode(delaymode),
        .delayctrlin(delayctrlin),
        .clkout(clkout) );
...
endmodule //arriav_duty_cycle_adjustment

`timescale 1 ps/1 ps

module    arriav_fractional_pll
#(
...
//input and output port declaration
	...
	arriav_fractional_pll_encrypted 
	#(
	...
	arriav_fractional_pll_encrypted_inst	(
        .cntnen(cntnen),
        .coreclkfb(coreclkfb),
		.ecnc1test(ecnc1test),
		.ecnc2test(ecnc2test),
...
endmodule //arriav_fractional_pll

`timescale 1 ps/1 ps

module    arriav_half_rate_input    (
    datain,
    directin,
    clk,
    areset,
    ...
    arriav_half_rate_input_encrypted inst (
        .datain(datain),
        .directin(directin),
        .clk(clk),
        .areset(areset),
...
endmodule //arriav_half_rate_input

`timescale 1 ps/1 ps

module    arriav_input_phase_alignment    (
    datain,
    levelingclk,
    zerophaseclk,
    areset,
    ...
    parameter    add_phase_transfer_reg    =    "false";
    parameter    lpm_type    =    "arriav_input_phase_alignment";
    ...
    arriav_input_phase_alignment_encrypted inst (
        .datain(datain),
        .levelingclk(levelingclk),
        .zerophaseclk(zerophaseclk),
        .areset(areset),
...
endmodule //arriav_input_phase_alignment

`timescale 1 ps/1 ps

module    arriav_io_clock_divider    (
    clk,
    phaseinvertctrl,
    masterin,
    clkout,
    ...
    parameter    lpm_type    =    "arriav_io_clock_divider";
    ...
    arriav_io_clock_divider_encrypted inst (
        .clk(clk),
        .phaseinvertctrl(phaseinvertctrl),
        .masterin(masterin),
        .clkout(clkout),
...
endmodule //arriav_io_clock_divider

`timescale 1 ps/1 ps

module arriav_io_config (
    datain,
    clk,
    ena,
    update,
    ...
    parameter    lpm_type    =    "arriav_io_config";
    ...
    arriav_io_config_encrypted inst (
        .datain(datain),
        .clk(clk),
        .ena(ena),
        .update(update),
...
endmodule //arriav_io_config

`timescale 1 ps/1 ps

module arriav_leveling_delay_chain (
    clkin,
    delayctrlin,
    clkout);
    ...
    arriav_leveling_delay_chain_encrypted inst (
        .clkin(clkin),
        .delayctrlin(delayctrlin),
        .clkout(clkout) );
    defparam inst.physical_clock_source = physical_clock_source;
...
endmodule //arriav_leveling_delay_chain

`timescale 1 ps/1 ps

module    arriav_pll_dll_output
#(
	// parameter declaration and default value assignemnt
...
//input and output port declaration
	...
	arriav_pll_dll_output_encrypted 
	#(
		.pll_dll_src(pll_dll_src)
	)
	arriav_pll_dll_output_encrypted_inst	(
        .cclk(cclk),
        .clkin(clkin),
		.clkout(clkout)
	);
endmodule //arriav_pll_dll_output

`timescale 1 ps/1 ps

module    arriav_pll_dpa_output
#(
	// parameter declaration and default value assignemnt
	parameter output_clock_frequency = "",	//Valid values: 
...
//input and output port declaration
	...
	arriav_pll_dpa_output_encrypted 
	#(
		.output_clock_frequency(output_clock_frequency),
		.pll_vcoph_div(pll_vcoph_div)
	)
	arriav_pll_dpa_output_encrypted_inst	(
        .pd(pd),
        .phin(phin),
		.phout(phout)
	);
endmodule //arriav_pll_dpa_output

`timescale 1 ps/1 ps

module    arriav_pll_extclk_output
#(
	// parameter declaration and default value assignemnt
...
endmodule //arriav_pll_extclk_output

`timescale 1 ps/1 ps

module    arriav_pll_lvds_output
#(
	// parameter declaration and default value assignemnt
...
//input and output port declaration
	...
	arriav_pll_lvds_output_encrypted 
	#(
	...
	arriav_pll_lvds_output_encrypted_inst	(
        .ccout(ccout),
        .loaden(loaden),
		.lvdsclk(lvdsclk)
	);
endmodule //arriav_pll_lvds_output

`timescale 1 ps/1 ps

module    arriav_pll_output_counter
#(
	// parameter declaration and default value assignemnt
	parameter output_clock_frequency = "",	//Valid values: 
...
//input and output port declaration
	...
	arriav_pll_output_counter_encrypted 
	#(
		.output_clock_frequency(output_clock_frequency),
	...
	arriav_pll_output_counter_encrypted_inst	(
        .cascadein(cascadein),
		.nen0(nen0),
		.nen1(nen1),
		.shift0(shift0),
...
endmodule //arriav_pll_output_counter

`timescale 1 ps/1 ps

module    arriav_pll_reconfig
(
//input and output port declaration
	input [ 5:0 ] addr,
	input [ 0:0 ] atpgmode,
	...
	arriav_pll_reconfig_encrypted arriav_pll_reconfig_encrypted_inst
	(
		.addr(addr),
        .atpgmode ( atpgmode ),
		.byteen(byteen),
...
endmodule //arriav_pll_reconfig

`timescale 1 ps/1 ps

module    arriav_pll_refclk_select
#(
	// parameter declaration and default value assignemnt
...
//input and output port declaration
	...
	arriav_pll_refclk_select_encrypted 
	#(
	...
	arriav_pll_refclk_select_encrypted_inst	(
		.adjpllin(adjpllin),
		.cclk(cclk),
		.clkin(clkin),
		.coreclkin(coreclkin),
...
endmodule //arriav_pll_refclk_select

`timescale 1 ps/1 ps

module    arriav_termination_logic    (
    s2pload,
    serdata,
    scanenable,
    scanclk,
    ...
    parameter    lpm_type    =    "arriav_termination_logic";
    ...
    arriav_termination_logic_encrypted inst (
        .s2pload(s2pload),
        .serdata(serdata),
...
endmodule //arriav_termination_logic

`timescale 1 ps/1 ps

module    arriav_termination    (
    rzqin,
    enserusr,
    nclrusr,
    clkenusr,
    ...
    parameter lpm_type = "arriav_termination";
    ...
    arriav_termination_encrypted inst (
        .rzqin(rzqin),
        .enserusr(enserusr),
        .nclrusr(nclrusr),
        .clkenusr(clkenusr),
...
module    arriav_asmiblock    (
    ...
    parameter    lpm_type    =    "arriav_asmiblock";
    ...
    arriav_asmiblock_encrypted inst (
        .dclk(dclk),
        .sce(sce),
        .oe(oe),
        .data0out(data0out),
...
endmodule //arriav_asmiblock

`timescale 1 ps/1 ps

module    arriav_chipidblock    (
    clk,
    shiftnld,
    regout);

    parameter    lpm_type    =    "arriav_chipidblock";
    ...
    arriav_chipidblock_encrypted inst (
        .clk(clk),
        .shiftnld(shiftnld),
        .regout(regout) );
    defparam inst.lpm_type = lpm_type;

endmodule //arriav_chipidblock

`timescale 1 ps/1 ps

module    arriav_controller    (
    nceout);

    parameter    lpm_type    =    "arriav_controller";


    output    nceout;

    arriav_controller_encrypted inst (
        .nceout(nceout) );
    defparam inst.lpm_type = lpm_type;

endmodule //arriav_controller

`timescale 1 ps/1 ps

module    arriav_crcblock    (
    clk,
    shiftnld,
    crcerror,
    regout);
    ...
    parameter    lpm_type    =    "arriav_crcblock";
    ...
    arriav_crcblock_encrypted inst (
        .clk(clk),
        .shiftnld(shiftnld),
        .crcerror(crcerror),
        .regout(regout) );
...
module    arriav_jtag    (
    ...
    parameter    lpm_type    =    "arriav_jtag";
...
endmodule //arriav_jtag

`timescale 1 ps/1 ps

module    arriav_prblock    (
    clk,
    corectl,
    prrequest,
    data,
    ...
    parameter    lpm_type    =    "arriav_prblock";
...
endmodule //arriav_prblock

`timescale 1 ps/1 ps

module    arriav_rublock    (
    clk,
    shiftnld,
    captnupdt,
    regin,
    ...
    parameter    lpm_type    =    "arriav_rublock";
...
module    arriav_tsdblock    (
    ...
    arriav_tsdblock_encrypted inst (
        .clk(clk),
        .ce(ce),
        .clr(clr),
        .tsdcalo(tsdcalo),
...
endmodule //arriav_tsdblock

`timescale 1 ps/1 ps

module arriav_read_fifo (
                           datain,
                           wclk,
                           we,
                           rclk,
    ...
    arriav_read_fifo_encrypted inst (
    	.datain(datain),
        .wclk(wclk),
        .we(we),
        .rclk(rclk),
...
endmodule //arriav_read_fifo

`timescale 1 ps/1 ps

module arriav_read_fifo_read_enable (
                           re,
                           rclk,
                           plus2,
                           areset,
    ...
    arriav_read_fifo_read_enable_encrypted inst (
    	.re(re),
    	.rclk(rclk),
    	.plus2(plus2),
    	.areset(areset),
...
endmodule //arriav_read_fifo_read_enable

module arriav_phy_clkbuf (	
						inclk,
						outclk
						);
	...
	arriav_phy_clkbuf_encrypted inst(	
		.inclk(inclk),
		.outclk(outclk));

endmodule //arriav_phy_clkbuf

module arriav_serdes_dpa (
		input  [ 0:0 ] txfclk,
		input  [ 0:0 ] txloaden,
		input  [ 0:0 ] ulvdsout,
		input  [ 0:0 ] rxfclk,
	...
	arriav_serdes_dpa_encrypted inst(
			.txfclk(txfclk),
			.txloaden(txloaden),
			.ulvdsout(ulvdsout),
			.rxfclk(rxfclk),
...
endmodule //arriav_serdes_dpa

module arriav_ir_fifo_userdes (
	...
	arriav_ir_fifo_userdes_encrypted inst(
		.tstclk(tstclk),
...
endmodule //arriav_ir_fifo_userdes

module arriav_read_fifo_read_clock_select (    
    input [2:0] clkin,
    input [1:0] clksel,
    output      clkout
    );

    arriav_read_fifo_read_clock_select_encrypted inst (
        .clkin(clkin),
        .clksel(clksel),
        .clkout(clkout));

endmodule //arriav_read_fifo_read_clock_select
...
endmodule //arriav_mac

`timescale 1 ps/1 ps

module arriav_mem_phy (
	aficasn,
	afimemclkdisable,
	afirasn,
	afirstn,
