...
primitive ARRIAIIGZ_PRIM_DFFE (Q, ENA, D, CLK, CLRN, PRN, notifier);
   input D;   
   input CLRN;
   input PRN;
   input CLK;
...
primitive ARRIAIIGZ_PRIM_DFFEAS (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
...
primitive ARRIAIIGZ_PRIM_DFFEAS_HIGH (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
    input d,clk,ena,clr,pre,ald,adt,sclr,sload, notifier;
    output q;
    reg q;
    initial
...
//--------------------------------------------------------------------
//
// Module Name : arriaiigz_crcblock
//
...
//------------------------------------------------------------------
//
// Module Name : arriaiigz_lcell_comb
//
// Description : ARRIAIIGZ LCELL_COMB Verilog simulation model 
//
//------------------------------------------------------------------

// Deactivate the following LEDA rules for arriaiigz_lcell_comb.v
...
//------------------------------------------------------------------
//
// Module Name : arriaiigz_routing_wire
//
...
endmodule // arriaiigz_routing_wire
///////////////////////////////////////////////////////////////////////////////
//
...
endmodule // arriaiigz_lvds_tx_reg

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriaiigz_lvds_tx_parallel_register
//
...
endmodule //arriaiigz_lvds_tx_parallel_register

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriaiigz_lvds_tx_out_block
//
...
endmodule //arriaiigz_lvds_tx_out_block

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriaiigz_lvds_transmitter
//
...
endmodule // arriaiigz_lvds_transmitter
///////////////////////////////////////////////////////////////////////
//
//              	ARRIAIIGZ RUBLOCK ATOM 
//
///////////////////////////////////////////////////////////////////////
...
//--------------------------------------------------------------------------
// Module Name     : arriaiigz_ram_block
...
//------------------------------------------------------------------
//
// Module Name : arriaiigz_ff
//
// Description : ARRIAIIGZ FF Verilog simulation model 
//
//------------------------------------------------------------------
`timescale 1 ps/1 ps
...
//------------------------------------------------------------------
//
// Module Name : arriaiigz_clkselect
//
// Description : ARRIAIIGZ CLKSELECT Verilog simulation model 
//
//------------------------------------------------------------------
...
//------------------------------------------------------------------
//
// Module Name : arriaiigz_and2
//
// Description : Simulation model for a simple 2-inputs AND gate.
//               This is used for the storing delays for ARRIAIIGZ CLKENA.
//
//------------------------------------------------------------------
...
endmodule // arriaiigz_ena_reg

//------------------------------------------------------------------
//
// Module Name : arriaiigz_clkena
//
// Description : ARRIAIIGZ CLKENA Verilog simulation model 
//
//------------------------------------------------------------------
...
//--------------------------------------------------------------------------
// Module Name     : arriaiigz_mlab_cell
// Description     : Main RAM module
//--------------------------------------------------------------------------
...
endmodule // arriaiigz_mlab_cell_block

//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriaiigz_io_ibuf                                 //
//Description:                    Simulation model for ARRIAIIGZ IO Input Buffer    //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

// Deactivate the following LEDA rules for arriaiigz_io_atom.v
// G_521_3B: Use uppercase letters for all parameter names
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriaiigz_io_obuf                                 //
//Description:                    Simulation model for ARRIAIIGZ IO Output Buffer   //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriaiigz_ddio_out                                //
//Description:                    Simulation model for ARRIAIIGZ DDIO Output        //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriaiigz_ddio_oe                                 //
//Description:                    Simulation model for ARRIAIIGZ DDIO OE            //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//Module Name:                    arriaiigz_ddio_in                                 
//Description:                    Simulation model for ARRIAIIGZ DDIO IN            
//                                                                              
////////////////////////////////////////////////////////////////////////////////
...
//                              1.arriaiigz_mac_register.                           //
//                              2.arriaiigz_mac_multiplier.                         //
//////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////
//  Module Name:             arriaiigz_saturation_block                                             //
...
//  Description:             ARRIAIIGZ rotate and shift Unit.                                       //
//////////////////////////////////////////////////////////////////////////////////////////////////
...
//  Description:             ARRIAIIGZ carry chain adder Unit.                                      //
//////////////////////////////////////////////////////////////////////////////////////////////////
...
// begin_ddr
//-----------------------------------------------------------------------------
// Module Name: arriaiigz_ddr_gray_decoder
...
//-----------------------------------------------------------------------------
// Module Name: arriaiigz_ddr_io_reg
...
//-----------------------------------------------------------------------------
//
// Module Name : arriaiigz_dll
//
// Description : ARRIAIIGZ Delay Locked Loop 
...
endmodule    // arriaiigz_dll

//-----------------------------------------------------------------------------
//
// Module Name : arriaiigz_offset_ctrl
//
// Description : ARRIAIIGZ Delay Locked Loop Offset Control 
//               Verilog simulation model 
//
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
...
begin
...
endmodule    // arriaiigz_offset_ctrl

 //-----------------------------------------------------------------------------
 //
 // Module Name : arriaiigz_dqs_delay_chain
 //
 // Description : ARRIAIIGZ DQS Delay Chain (within DQS I/O) 
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
 ...
 endmodule    // arriaiigz_dqs_delay_chain
 
 
//-----------------------------------------------------------------------------
//
// Module Name : arriaiigz_dqs_enable
//
// Description : ARRIAIIGZ DQS Enable 
//               Verilog simulation model 
//
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
...
pmos (dqsbusout, tmp_dqsbusout, 1'b0);
...
endmodule    // arriaiigz_dqs_enable


 //-----------------------------------------------------------------------------
 //
 // Module Name : arriaiigz_dqs_enable_ctrl
 //
 // Description : ARRIAIIGZ DQS Enable Control
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
 ...
 endmodule    // arriaiigz_dqs_enable_ctrl
 
 
 //-----------------------------------------------------------------------------
 //
 // Module Name : arriaiigz_delay_chain
 //
 // Description : ARRIAIIGZ Delay Chain (dynamic adjustable delay chain) 
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
 ...
 endmodule    // arriaiigz_delay_chain
 
 
  //-----------------------------------------------------------------------------
  //
  // Module Name : arriaiigz_io_clock_divider
  //
  // Description : ARRIAIIGZ I/O Clock Divider 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
 ...
 // LOCAL_PARAMETERS_END
  ...
  endmodule    // arriaiigz_io_clock_divider
  
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : arriaiigz_output_phase_alignment
  //
 ...
 // Duty Cycle Delay
  ...
  endmodule    // arriaiigz_output_phase_alignment
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : arriaiigz_input_phase_alignment
  //
 ...
 // LOCAL_PARAMETERS_END
  ...
  endmodule    // arriaiigz_input_phase_alignment
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : arriaiigz_half_rate_input
  //
  // Description : ARRIAIIGZ half rate input 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
  ...
  endmodule    // arriaiigz_half_rate_input
  ...
  //
  // Description : ARRIAIIGZ I/O Configuration Register 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
  ...
  endmodule    // arriaiigz_io_config
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : arriaiigz_dqs_config
  //
  // Description : ARRIAIIGZ DQS Configuration Register 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
  ...
  endmodule    // arriaiigz_dqs_config
...
parameter ARRIAIIGZ_RTOCT_WAIT         = 5'b00000;
...
parameter ARRIAIIGZ_RTOCT_INC_PN       = 5'b01000;
parameter ARRIAIIGZ_RTOCT_DEC_PN       = 5'b01001;
parameter ARRIAIIGZ_RTOCT_INC_P        = 5'b01010;
parameter ARRIAIIGZ_RTOCT_DEC_P        = 5'b01011;
parameter ARRIAIIGZ_RTOCT_INC_N        = 5'b01100;
parameter ARRIAIIGZ_RTOCT_DEC_N        = 5'b01101;
parameter ARRIAIIGZ_RTOCT_SWITCH_REG   = 5'b10001;
parameter ARRIAIIGZ_RTOCT_DONE         = 5'b11111;
...
begin
    ...
    ARRIAIIGZ_RTOCT_INC_P,ARRIAIIGZ_RTOCT_DEC_P,ARRIAIIGZ_RTOCT_INC_N,ARRIAIIGZ_RTOCT_DEC_N :
...
endmodule    // arriaiigz_termination
...
endmodule    // arriaiigz_termination_logic
//--------------------------------------------------------------------------
...
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriaiigz_m_cntr
//
// Description : Timing simulation model for the M counter. This is the
//               loop feedback counter for the ARRIAIIGZ PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // arriaiigz_m_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriaiigz_n_cntr
//
// Description : Timing simulation model for the N counter. This is the
//               input clock divide counter for the ARRIAIIGZ PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // arriaiigz_n_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriaiigz_scale_cntr
//
...
endmodule // arriaiigz_scale_cntr

//BEGIN MF PORTING DELETE
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriaiigz_pll_reg
//
// Description : Simulation model for a simple DFF.
...
endmodule // arriaiigz_pll_reg
//END MF PORTING DELETE

//////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriaiigz_pll
//
...
endmodule // arriaiigz_pll
//---------------------------------------------------------------------
//
// Module Name : arriaiigz_asmiblock
//
// Description : ARRIAIIGZ ASMIBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
...
endmodule  // arriaiigz_asmiblock
//---------------------------------------------------------------------
//
// Module Name : arriaiigz_tsdblock
//
// Description : ARRIAIIGZ TSDBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
...
endmodule // arriaiigz_lvds_rx_fifo
...
endmodule // arriaiigz_lvds_rx_bitslip
...
endmodule //arriaiigz_lvds_rx_deser
...
endmodule //arriaiigz_lvds_rx_parallel_reg
...
module arriaiigz_dpa_block(clkin,
                dpareset,
                dpahold,
                datain,
                clkout,
...
arriaiigz_dpa_retime_block data_clock_retime(
                                        .clkin(clkin),
                                        .datain(datain),
                                        .reset(dpareset),
                                        .clk0(clk0_tmp),
...
//               4) arriaiigz_lvds_rx_deser
//               5) arriaiigz_lvds_rx_parallel_reg
//               6) arriaiigz_select_ini_phase_dpaclk
//               7)arriaiigz_dpa_block
//               8) arriaiigz_pclk_divider
//
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // arriaiigz_lvds_receiver
//////////////////////////////////////////////////////////////////////////////////
...
// Deactivate the following LEDA rules for arriaiigz_pseudo_diff_atom.v
// G_521_3B: Use uppercase letters for all parameter names
// leda G_521_3_B off
...
// -----------------------------------------------------------
//
// Module Name : arriaiigz_bias_logic
//
...
endmodule // arriaiigz_bias_logic

// -----------------------------------------------------------
//
// Module Name : arriaiigz_bias_generator
//
// Description : ARRIAIIGZ Bias Generator Verilog simulation model
//
// -----------------------------------------------------------
...
endmodule // arriaiigz_bias_generator

// -----------------------------------------------------------
//
// Module Name : arriaiigz_bias_block
//
// Description : ARRIAIIGZ Bias Block Verilog simulation model
//
// -----------------------------------------------------------
...
endmodule // arriaiigz_bias_block
