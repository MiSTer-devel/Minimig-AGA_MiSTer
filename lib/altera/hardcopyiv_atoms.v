...
primitive HARDCOPYIV_PRIM_DFFE (Q, ENA, D, CLK, CLRN, PRN, notifier);
   input D;   
   input CLRN;
   input PRN;
   input CLK;
...
primitive HARDCOPYIV_PRIM_DFFEAS (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
...
primitive HARDCOPYIV_PRIM_DFFEAS_HIGH (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
    input d,clk,ena,clr,pre,ald,adt,sclr,sload, notifier;
    output q;
    reg q;
    initial
...
module hardcopyiv_dffe ( Q, CLK, ENA, D, CLRN, PRN );
   input D;
   input CLK;
   input CLRN;
   input PRN;
   ...
   HARDCOPYIV_PRIM_DFFE ( Q, ENA_ipd, D_ipd, CLK_ipd, CLRN_ipd, PRN_ipd, viol_notifier );
...
module hardcopyiv_mux21 (MO, A, B, S);
   input A, B, S;
   output MO;
...
module hardcopyiv_mux41 (MO, IN0, IN1, IN2, IN3, S);
   input IN0;
   input IN1;
   input IN2;
   input IN3;
...
//--------------------------------------------------------------------
//
// Module Name : hardcopyiv_jtag
//
// Description : hardcopyiv JTAG Verilog Simulation model
//
//--------------------------------------------------------------------
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiv_lcell_comb
//
// Description : HARDCOPYIV LCELL_COMB Verilog simulation model 
//
//------------------------------------------------------------------

// Deactivate the following LEDA rules for hardcopyiv_lcell_comb.v
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiv_routing_wire
//
...
module hardcopyiv_routing_wire (
                               datain,
                               dataout
                               );
...
endmodule // hardcopyiv_routing_wire
///////////////////////////////////////////////////////////////////////////////
//
...
`timescale 1ps / 1ps
module hardcopyiv_lvds_tx_reg (q,
                clk,
                ena,
                d,
                clrn,
...
endmodule // hardcopyiv_lvds_tx_reg

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiv_lvds_tx_parallel_register
//
...
`timescale 1 ps/1 ps
module hardcopyiv_lvds_tx_parallel_register (clk,
                                            enable,
                                            datain,
                                            dataout,
                                            devclrn,
...
endmodule //hardcopyiv_lvds_tx_parallel_register

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiv_lvds_tx_out_block
//
...
`timescale 1 ps/1 ps
module hardcopyiv_lvds_tx_out_block (clk,
                                    datain,
                                    dataout,
                                    devclrn,
                                    devpor
...
endmodule //hardcopyiv_lvds_tx_out_block

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiv_lvds_transmitter
//
...
`timescale 1 ps/1 ps
module hardcopyiv_lvds_transmitter (clk0,
                                   enable0,
                                   datain,
                                   serialdatain,
                                   postdpaserialdatain,
...
// SIMULATION_ONLY_PARAMETERS_END
    ...
    hardcopyiv_lvds_tx_reg txload0_reg (.d(enable0),
                             .clrn(1'b1),
                             .prn(1'b1),
                             .ena(1'b1),
                             .clk(clk0_in),
    ...
    hardcopyiv_lvds_tx_out_block output_module (.clk(clk0_in),
                                               .datain(shift_out),
                                               .dataout(dataout_tmp),
                                               .devclrn(devclrn),
                                               .devpor(devpor)
    ...
    hardcopyiv_lvds_tx_parallel_register input_reg (.clk(txload0),
                                                   .enable(1'b1),
                                                   .datain(datain_dly),
                                                   .dataout(input_data),
                                                   .devclrn(devclrn),
...
module hardcopyiv_ram_pulse_generator (
                                    clk,
                                    ena,
                                    pulse,
                                    cycle
...
module hardcopyiv_ram_register (
                             d,
                             clk,
                             aclr,
                             devclrn,
...
//--------------------------------------------------------------------------
// Module Name     : hardcopyiv_ram_block
...
// port A core active
hardcopyiv_ram_register active_core_port_a (
       .d(active_a_core_in),
       .clk(clk_a_in),
       .aclr(1'b0),
       .devclrn(1'b1),
...
// port B core active
hardcopyiv_ram_register active_core_port_b (
       .d(active_b_core_in),
       .clk(clk_b_in),
       .aclr(1'b0),
       .devclrn(1'b1),
...
// ------- A input registers -------
// write enable
hardcopyiv_ram_register we_a_register (
...
// read enable
hardcopyiv_ram_register re_a_register (
        .d(portare_int),
        .clk(clk_a_rena),
        .aclr(re_a_clr_in),
        .devclrn(devclrn),
...
// address
hardcopyiv_ram_register addr_a_register (
        .d(portaaddr_int),
        .clk(clk_a_in),
        .aclr(addr_a_clr_in),
...
// data
hardcopyiv_ram_register datain_a_register (
        .d(portadatain_int),
        .clk(clk_a_in),
...
// byte enable
hardcopyiv_ram_register byteena_a_register (
...
hardcopyiv_ram_register we_b_register (
        .d(portbwe_int),
        .clk(clk_b_wena),
        .aclr(we_b_clr_in),
        .stall(1'b0),
...
hardcopyiv_ram_register re_b_register (
        .d(portbre_int),
        .clk(clk_b_rena),
        .aclr(re_b_clr_in),
        .stall(1'b0),
...
// address
hardcopyiv_ram_register addr_b_register (
        .d(portbaddr_int),
        .clk(clk_b_in),
        .aclr(addr_b_clr_in),
        .devclrn(devclrn),
...
// data
hardcopyiv_ram_register datain_b_register (
        .d(portbdatain_int),
        .clk(clk_b_in),
...
// byte enable
hardcopyiv_ram_register byteena_b_register (
...
hardcopyiv_ram_pulse_generator wpgen_a (
       .clk(clk_a_in),
...
hardcopyiv_ram_pulse_generator wpgen_b (
       .clk(clk_b_in),
...
hardcopyiv_ram_pulse_generator rpgen_a (
        .clk(clk_a_in),
...
hardcopyiv_ram_pulse_generator rpgen_b (
        .clk(clk_b_in),
...
hardcopyiv_ram_pulse_generator rwpgen_a (
    .clk(clk_a_in),
     .ena(active_a_core & re_a_reg & we_a_reg & read_before_write_a),
    .pulse(rw_pulse_a),.cycle()
);

hardcopyiv_ram_pulse_generator rwpgen_b (
    .clk(clk_b_in),
...
begin
 ...
 // port A
 hardcopyiv_ram_register aclr__a__mux_register (
        .d(dataout_a_clr),
        .clk(clk_a_core),
        .aclr(1'b0),
        .devclrn(devclrn),
 ...
 // port B
 hardcopyiv_ram_register aclr__b__mux_register (
        .d(dataout_b_clr),
        .clk(clk_b_core),
        .aclr(1'b0),
        .devclrn(devclrn),
...
hardcopyiv_ram_register dataout_a_register (
        .d(dataout_a),
        .clk(clk_a_out),
 .aclr(dataout_a_clr),
        .devclrn(devclrn),
...
hardcopyiv_ram_register dataout_b_register (
        .d( dataout_b ),
        .clk(clk_b_out),
 .aclr(dataout_b_clr),
        .devclrn(devclrn),.devpor(devpor),
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiv_ff
//
// Description : HARDCOPYIV FF Verilog simulation model 
//
//------------------------------------------------------------------
`timescale 1 ps/1 ps
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiv_clkselect
//
// Description : HARDCOPYIV CLKSELECT Verilog simulation model 
//
//------------------------------------------------------------------
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiv_and2
//
// Description : Simulation model for a simple 2-inputs AND gate.
//               This is used for the storing delays for HARDCOPYIV CLKENA.
//
//------------------------------------------------------------------

`timescale 1ps / 1ps

module hardcopyiv_and2 (
                IN1,
                IN2,
                Y
               );
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiv_ena_reg
//
// Description : Simulation model for a simple DFF.
...
endmodule // hardcopyiv_ena_reg

//------------------------------------------------------------------
//
// Module Name : hardcopyiv_clkena
//
// Description : HARDCOPYIV CLKENA Verilog simulation model 
//
//------------------------------------------------------------------
...
hardcopyiv_ena_reg extena_reg1(
                    .clk(!inclk),
                    .ena(1'b1),
                    .d(ena),
                    .clrn(1'b1),
...
hardcopyiv_ena_reg extena_reg2(
                    .clk(!inclk),
                    .ena(1'b1),
                    .d(cereg1_out),
                    .clrn(1'b1),
...
hardcopyiv_and2 outclk_and(
                .IN1(inclk),
                .IN2(ena_out),
                .Y(outclk)
                );

hardcopyiv_and2 enaout_and(
                .IN1(1'b1),
                .IN2(ena_out),
                .Y(enaout)
                );
...
//--------------------------------------------------------------------------
// Module Name     : hardcopyiv_hram_pulse_generator
// Description     : Generate pulse to initiate memory read/write operations
//--------------------------------------------------------------------------
`timescale 1 ps/1 ps

module hardcopyiv_hram_pulse_generator (
                                    clk,     
                                    ena,     
                                    pulse,
                                    cycle    
...
// data register
hardcopyiv_ram_register data_b_register(
        .d(dataout_b),
        .clk(clk_b_out),
...
// Write pulse generation
hardcopyiv_hram_pulse_generator wpgen_a (
        .clk(~clk_a_in),
        .ena(ena0_reg),
        .pulse(write_pulse),
	    .cycle(write_cycle)
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    hardcopyiv_io_ibuf                                 //
//Description:                    Simulation model for HARDCOPYIV IO Input Buffer    //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

// Deactivate the following LEDA rules for hardcopyiv_io_atom.v
// G_521_3B: Use uppercase letters for all parameter names
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    hardcopyiv_io_obuf                                 //
//Description:                    Simulation model for HARDCOPYIV IO Output Buffer   //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    hardcopyiv_ddio_out                                //
//Description:                    Simulation model for HARDCOPYIV DDIO Output        //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    hardcopyiv_ddio_oe                                 //
//Description:                    Simulation model for HARDCOPYIV DDIO OE            //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//Module Name:                    hardcopyiv_ddio_in                                 
//Description:                    Simulation model for HARDCOPYIV DDIO IN            
//                                                                              
////////////////////////////////////////////////////////////////////////////////
...
`timescale 1 ps/1 ps
module hardcopyiv_mac_register (
                           datain,
                           clk,
                           aclr,
                           sload,
...
//                              1.hardcopyiv_mac_register.                           //
//                              2.hardcopyiv_mac_multiplier.                         //
//////////////////////////////////////////////////////////////////////////////////
...
hardcopyiv_mac_register dataa_input_register (
                                         .datain(dataa),
                                         .clk(dataa_clk),
                                         .aclr(dataa_aclr),
                                         .sload(dataa_sload),
...
hardcopyiv_mac_register datab_input_register (
                                         .datain(datab),
                                         .clk(datab_clk),
                                         .aclr(datab_aclr),
                                         .sload(datab_sload),
...
hardcopyiv_mac_register signa_input_register (
                                         .datain(signa),
                                         .clk(signa_clk),
                                         .aclr(signa_aclr),
                                         .sload(signa_sload),
...
hardcopyiv_mac_register signb_input_register (
                                         .datain(signb),
                                         .clk(signb_clk),
                                         .aclr(signb_aclr),
                                         .sload(signb_sload),
...
hardcopyiv_mac_register scanouta_input_register (
                                             .datain(dataa_in_reg),
                                             .clk(scanouta_clk),
                                             .aclr(scanouta_aclr),
...
hardcopyiv_mac_multiplier mac_multiplier (
                                     .dataa(dataa_in_reg),
                                     .datab(datab_in_reg),
                                     .signa(signa_mult),
                                     .signb(signb_mult),
...
//////////////////////////////////////////////////////////////////////////////////////////////////
//  Module Name:             hardcopyiv_saturation_block                                             //
...
//////////////////////////////////////////////////////////////////////////////////////////////////
module hardcopyiv_round_saturate_block(
                                   datain,
                                   round,
                                   saturate,
                                   signa,
...
hardcopyiv_round_block round_unit  (
                              .datain(datain),
                              .round(round),
...
hardcopyiv_saturate_block saturate_unit(
...
//  Description:             HARDCOPYIV rotate and shift Unit.                                       //
//////////////////////////////////////////////////////////////////////////////////////////////////
...
//  Description:             HARDCOPYIV carry chain adder Unit.                                      //
//////////////////////////////////////////////////////////////////////////////////////////////////
...
hardcopyiv_mac_register zeroloopback_input_register (
                                                .datain(zeroloopback),
...
hardcopyiv_mac_register zeroacc_input_register (
                                           .datain(zeroacc),
                                           .clk(zeroacc_clk_ir),
...
hardcopyiv_mac_register rotate_input_register (
                                         .datain(rotate),
                                         .clk(rotate_clk_ir),
                                         .aclr(rotate_aclr_ir),
...
hardcopyiv_mac_register shiftright_input_register (
                                              .datain(shiftright),
...
hardcopyiv_mac_register round_input_register (
                                         .datain(round),
                                         .clk(round_clk_ir),
                                         .aclr(round_aclr_ir),
...
hardcopyiv_mac_register saturate_input_register (
                                            .datain(saturate),
                                            .clk(saturate_clk_ir),
...
hardcopyiv_mac_register roundchainout_input_register (
...
hardcopyiv_mac_register saturatechainout_input_register (
...
//Instantiate the First level adder interface and sign extension block
 hardcopyiv_fsa_isse fsa_interface(
                              .dataa(dataa),
                              .datab(datab),
                              .datac(datac),
                              .datad(datad),
...
hardcopyiv_first_stage_add_sub fsaunit0(
                                  .dataa(dataa_fsa_in),
                                  .datab(datab_fsa_in),
                                  .sign(sign),
                                  .operation(operation),
...
hardcopyiv_first_stage_add_sub fsaunit1(
                                  .dataa(datac_fsa_in),
                                  .datab(datad_fsa_in),
                                  .sign(sign),
                                  .operation(operation),
...
hardcopyiv_mac_register zeroloopback_pipeline_register (
...
hardcopyiv_mac_register zeroacc_pipeline_register (
...
hardcopyiv_mac_register signa_pipeline_register (
                                             .datain(signa_in_reg),
                                             .clk(signa_clk_pip),
                                             .aclr(signa_aclr_pip),
...
hardcopyiv_mac_register signb_pipeline_register (
                                             .datain(signb_in_reg),
                                             .clk(signb_clk_pip),
                                             .aclr(signb_aclr_pip),
...
hardcopyiv_mac_register rotate_pipeline_register (
...
hardcopyiv_mac_register shiftright_pipeline_register (
...
hardcopyiv_mac_register round_pipeline_register (
                                             .datain(round_in_reg),
                                             .clk(round_clk_pip),
                                             .aclr(round_aclr_pip),
...
hardcopyiv_mac_register saturate_pipeline_register (
...
hardcopyiv_mac_register roundchainout_pipeline_register (
...
hardcopyiv_mac_register saturatechainout_pipeline_register (
...
hardcopyiv_mac_register fsa0_pipeline_register (
...
hardcopyiv_mac_register fsa1_pipeline_register (
                                           .datain(dataout_fsa1),
                                           .clk(fsa1_clk_pip),
                                           .aclr(fsa1_aclr_pip),
...
hardcopyiv_second_stage_add_accum ssa_unit(
                                      .dataa(fsa0_pip_reg),
                                      .datab(fsa1_pip_reg),
...
hardcopyiv_round_saturate_block rs_block(
                                   .datain(rs_datain),
                                   .round(round_pip_reg),
...
hardcopyiv_mac_register zeroloopback_output_register (
...
hardcopyiv_mac_register zerochainout_output_register (
                                                 .datain(zerochainout),
...
hardcopyiv_mac_register rs_dataout_output_register (
...
hardcopyiv_mac_register rs_saturation_overflow_output_register (
...
hardcopyiv_mac_register rotate_output_register (
...
hardcopyiv_mac_register shiftright_output_register (
...
hardcopyiv_mac_register roundchainout_output_register (
...
hardcopyiv_mac_register saturatechainout_output_register (
...
hardcopyiv_mac_register coa_rs_saturation_overflow_register (
...
hardcopyiv_mac_register coa_rs_saturationchainout_overflow_register (
...
hardcopyiv_mac_register coa_rs_dataout_register (
...
hardcopyiv_rotate_shift_block shift_rot_unit(
...
// begin_ddr
//-----------------------------------------------------------------------------
// Module Name: hardcopyiv_ddr_gray_decoder
...
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
module hardcopyiv_ddr_delay_chain_s (
        clk, 
        delayctrlin, 
        phasectrlin, 
        delayed_clkout
...
hardcopyiv_ddr_gray_decoder m_delayctrl_in_dec(delayctrlin_in, delayctrl_bin);
...
//-----------------------------------------------------------------------------
//
// Module Name : hardcopyiv_dll
//
// Description : HARDCOPYIV Delay Locked Loop 
...
parameter dual_phase_comparators = "true"; // new in hardcopyiv
...
wire       jc_upndn_in;
wire       jc_aload_in;
wire       jc_clkena_in;  // new in hardcopyiv
...
// phase comparator
wire       pc_lock;      // new in hardcopyiv
wire       pc_upndn_out;
...
reg        pc_reg_upndn;
integer    pc_delay;
reg        pc_lock_reg;   // new in hardcopyiv
integer    pc_comp_range; // new in hardcopyiv
...
// Delay Setting Control Counter ----------------------------------------------
    ...
    assign dc_upndnclkena_in = (para_use_upndninclkena === 1'b1) ? upndninclkena : 
                               ...
                               (dual_phase_comparators == "true") ? ~pc_lock : 1'b1;  // new in hardcopyiv
...
//-----------------------------------------------------------------------------
//
// Module Name : hardcopyiv_offset_ctrl
//
// Description : HARDCOPYIV Delay Locked Loop Offset Control 
//               Verilog simulation model 
//
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
...
// TCO DELAYS, IO PATH and SETUP-HOLD CHECKS
// These timing paths existed from HARDCOPYIV, currently not modeled in hardcopyiv
specify
...
begin
   ...
   assign dr_offsettest_out = (use_offset == "false") ? para_static_offset[5:0] : offset_in;
    ...
    // gray decoder
    hardcopyiv_ddr_gray_decoder mdr_delayctrl_in_dec(dr_delayctrl_in_gray, dr_delayctrl_in_bin);
    hardcopyiv_ddr_gray_decoder mdr_offset_in_dec(dr_offset_in_gray, dr_offset_in_bin);
    hardcopyiv_ddr_gray_decoder mpara_static_offset_dec(para_static_offset_gray, para_static_offset_bin);
...
endmodule    // hardcopyiv_offset_ctrl

 //-----------------------------------------------------------------------------
 //
 // Module Name : hardcopyiv_dqs_delay_chain
 //
 // Description : HARDCOPYIV DQS Delay Chain (within DQS I/O) 
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
 ...
 // decode
 hardcopyiv_ddr_gray_decoder m_delayctrl_in_dec (delayctrl_reg_mux,  delayctrl_bin);
 hardcopyiv_ddr_gray_decoder m_offsetctrl_in_dec(offsetctrl_reg_mux, offsetctrl_bin);
...
//-----------------------------------------------------------------------------
//
// Module Name : hardcopyiv_dqs_enable
//
// Description : HARDCOPYIV DQS Enable 
//               Verilog simulation model 
//
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
...
pmos (dqsbusout, tmp_dqsbusout, 1'b0);
 ...
 //-----------------------------------------------------------------------------
 //
 // Module Name : hardcopyiv_dqs_enable_ctrl
 //
 // Description : HARDCOPYIV DQS Enable Control
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
 ...
 // delay chain
 hardcopyiv_ddr_delay_chain_s m_delay_chain(
                         .clk(clk_in), 
 ...
 hardcopyiv_ddr_io_reg  dqsenablein_reg(
                       .d(dqsenablein_in), 
                       .clk(clk_in), 
                       .ena(1'b1), 
                       .clrn(1'b1), 
 ...
 hardcopyiv_ddr_io_reg  dqsenable_transfer_reg(
                       .d(dqsenablein_reg_q), 
                       .clk(~delayed_clk), 
                       .ena(1'b1), 
                       .clrn(1'b1), 
 ...
 hardcopyiv_ddr_io_reg  dqsenableout_reg(
 ...
 hardcopyiv_ddr_io_reg  dqsenableout_extend_reg(
 ...
 //-----------------------------------------------------------------------------
 //
 // Module Name : hardcopyiv_delay_chain
 //
 // Description : HARDCOPYIV Delay Chain (dynamic adjustable delay chain) 
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
 ...
 assign dataout = tmp_dataout;
  ...
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiv_io_clock_divider
  //
  // Description : HARDCOPYIV I/O Clock Divider 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
 ...
 // LOCAL_PARAMETERS_END
  ...
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiv_output_phase_alignment
  //
 ...
 // LOCAL_PARAMETERS_END
  ...
  hardcopyiv_ddr_delay_chain_s m_clk_in_delay_chain(
                          .clk(clk_in), 
                          .delayctrlin(delayctrlin_in), 
                          .phasectrlin(phasectrlin_in), 
  ...
  // Datain Register
  hardcopyiv_ddr_io_reg  datain_reg(
                        .d(datain_in[0]), 
                        .clk(clk_in_mux), 
                        .ena(1'b1), 
                        .clrn(clrn_in_r), 
  ...
  hardcopyiv_ddr_io_reg  ddio_datain_reg(
                        .d(datain_in[1]), 
                        .clk(clk_in_mux), 
                        .ena(1'b1), 
                        .clrn(clrn_in_r), 
  ...
  hardcopyiv_ddr_io_reg  cycledelay_reg(
                        .d(datain_q), 
                        .clk(clk_in_mux), 
                        .ena(1'b1), 
                        .clrn(clrn_in_r), 
  ...
  hardcopyiv_ddr_io_reg  ddio_cycledelay_reg(
                        .d(ddio_datain_q), 
                        .clk(clk_in_mux), 
                        .ena(1'b1), 
                        .clrn(clrn_in_r), 
  ...
  hardcopyiv_ddr_io_reg  transferdelay_reg(
 ...
 // Duty Cycle Delay
  ...
  hardcopyiv_ddr_io_reg  dlyclk_reg(
                        .d(dlyclk_d), 
                        .clk(dlyclk_clk), 
  ...
  // transfer delay is implemented with negative register in rev1.26 
  hardcopyiv_ddr_io_reg  ddio_transferdelay_reg(
  ...
  // Output Register clocked by phasectrl_clk
  hardcopyiv_ddr_io_reg  ddio_dlyclk_reg(
                        .d(ddio_dlyclk_d), 
                        .clk(dlyclk_clk), 
                        .ena(dlyclk_clkena_in), 
                        .clrn(clrn_in_r), 
  ...
  hardcopyiv_ddr_io_reg  dlyclk_extended_reg(
                        .d(dlyclk_q), 
  ...
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiv_input_phase_alignment
  //
 ...
 // LOCAL_PARAMETERS_END
  ...
  hardcopyiv_ddr_io_reg  transfer_reg(
  ...
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiv_half_rate_input
  //
  // Description : HARDCOPYIV half rate input 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
  ...
  // datain_1 - L (n)  
  hardcopyiv_ddr_io_reg  reg1_l_n(
                        .d(datain_in[1]), 
                        .clk(neg_clk_in), 
                        .ena(1'b1), 
                        .clrn(1'b1), 
  ...
  // datain_0 - L (n)  
  hardcopyiv_ddr_io_reg  reg0_l_n(
                        .d(datain_in[0]), 
                        .clk(neg_clk_in), 
                        .ena(1'b1), 
                        .clrn(1'b1), 
  ...
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiv_io_config
  //
  // Description : HARDCOPYIV I/O Configuration Register 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
  ...
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiv_dqs_config
  //
  // Description : HARDCOPYIV DQS Configuration Register 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
...
parameter HARDCOPYIV_RTOCT_WAIT         = 5'b00000;
...
parameter HARDCOPYIV_RTOCT_INC_PN       = 5'b01000;
parameter HARDCOPYIV_RTOCT_DEC_PN       = 5'b01001;
parameter HARDCOPYIV_RTOCT_INC_P        = 5'b01010;
parameter HARDCOPYIV_RTOCT_DEC_P        = 5'b01011;
parameter HARDCOPYIV_RTOCT_INC_N        = 5'b01100;
parameter HARDCOPYIV_RTOCT_DEC_N        = 5'b01101;
parameter HARDCOPYIV_RTOCT_SWITCH_REG   = 5'b10001;
parameter HARDCOPYIV_RTOCT_DONE         = 5'b11111;
...
begin
    ...
    HARDCOPYIV_RTOCT_INC_P,HARDCOPYIV_RTOCT_DEC_P,HARDCOPYIV_RTOCT_INC_N,HARDCOPYIV_RTOCT_DEC_N :
...
// clk divider ----------------------------------------------------------------
hardcopyiv_termination_aux_clock_div m_gen_calclk (
    .clk(usr_clk), 
...
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiv_m_cntr
//
// Description : Timing simulation model for the M counter. This is the
//               loop feedback counter for the HARDCOPYIV PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // hardcopyiv_m_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiv_n_cntr
//
// Description : Timing simulation model for the N counter. This is the
//               input clock divide counter for the HARDCOPYIV PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // hardcopyiv_n_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiv_scale_cntr
//
...
endmodule // hardcopyiv_scale_cntr

//BEGIN MF PORTING DELETE
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiv_pll_reg
//
// Description : Simulation model for a simple DFF.
...
endmodule // hardcopyiv_pll_reg
//END MF PORTING DELETE

//////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiv_pll
//
...
// SIMULATION_ONLY_PARAMETERS_BEGIN
    ...
    parameter family_name = "HARDCOPYIV";
...
// LOCAL_PARAMETERS_END
    ...
    // this is for hardcopyiv lvds only
...
// Determine the inclk1 frequency
    ...
    hardcopyiv_m_cntr m1 (.clk(inclk_m),
    ...
    hardcopyiv_n_cntr n1 (.clk(inclk_n),
                        .reset(areset),
                        .cout(refclk),
                        .modulus(n_val[0]));
...
always @(vco_out)
    ...
    hardcopyiv_scale_cntr c0 (.clk(inclk_c0),
                            .reset(areset  || stop_vco),
                            .cout(c0_clk),
                            .high(c_high_val[0]),
                            .low(c_low_val[0]),
    ...
    hardcopyiv_scale_cntr c1 (.clk(inclk_c1),
                            .reset(areset || stop_vco),
                            .cout(c1_clk),
                            .high(c_high_val[1]),
                            .low(c_low_val[1]),
    ...
    hardcopyiv_scale_cntr c2 (.clk(inclk_c2),
                            .reset(areset || stop_vco),
                            .cout(c2_clk),
                            .high(c_high_val[2]),
                            .low(c_low_val[2]),
    ...
    hardcopyiv_scale_cntr c3 (.clk(inclk_c3),
                            .reset(areset  || stop_vco),
                            .cout(c3_clk),
                            .high(c_high_val[3]),
                            .low(c_low_val[3]),
    ...
    hardcopyiv_scale_cntr c4 (.clk(inclk_c4),
                            .reset(areset || stop_vco),
                            .cout(c4_clk),
                            .high(c_high_val[4]),
                            .low(c_low_val[4]),
    ...
    hardcopyiv_scale_cntr c5 (.clk(inclk_c5),
                            .reset(areset  || stop_vco),
                            .cout(c5_clk),
                            .high(c_high_val[5]),
                            .low(c_low_val[5]),
    ...
    hardcopyiv_scale_cntr c6 (.clk(inclk_c6),
                            .reset(areset  || stop_vco),
                            .cout(c6_clk),
                            .high(c_high_val[6]),
                            .low(c_low_val[6]),
    ...
    hardcopyiv_scale_cntr c7 (.clk(inclk_c7),
                            .reset(areset  || stop_vco),
                            .cout(c7_clk),
                            .high(c_high_val[7]),
                            .low(c_low_val[7]),
    ...
    hardcopyiv_scale_cntr c8 (.clk(inclk_c8),
                            .reset(areset || stop_vco),
                            .cout(c8_clk),
                            .high(c_high_val[8]),
                            .low(c_low_val[8]),
    ...
    hardcopyiv_scale_cntr c9 (.clk(inclk_c9),
                            .reset(areset  || stop_vco),
                            .cout(c9_clk),
                            .high(c_high_val[9]),
                            .low(c_low_val[9]),
...
//---------------------------------------------------------------------
//
// Module Name : hardcopyiv_asmiblock
//
// Description : HARDCOPYIV ASMIBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
...
//---------------------------------------------------------------------
//
// Module Name : hardcopyiv_tsdblock
//
// Description : HARDCOPYIV TSDBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
...
`timescale 1 ps/1 ps
module hardcopyiv_lvds_rx_fifo (
                           wclk,
                           rclk,
                           dparst,
                           fiforst,
    ...
    hardcopyiv_lvds_rx_fifo_sync_ram  s_fifo_ram (
                                             .clk(wclk),
                                             .datain(ram_datain),
...
endmodule // hardcopyiv_lvds_rx_fifo
...
`timescale 1 ps/1 ps
module hardcopyiv_lvds_rx_bitslip (
                              clk0,
                              bslipcntl,
                              bsliprst,
                              datain,
    ...
    hardcopyiv_lvds_reg bslipcntlreg (
                                .d(bslipcntl),
                                .clk(clk0),
                                .ena(1'b1),
                                .clrn(!bsliprst),
...
hardcopyiv_lvds_reg dataoutreg (
...
endmodule // hardcopyiv_lvds_rx_bitslip
...
endmodule //hardcopyiv_lvds_rx_deser
...
endmodule //hardcopyiv_lvds_rx_parallel_reg
...
module hardcopyiv_dpa_block(clkin,
                dpareset,
                dpahold,
                datain,
                clkout,
...
hardcopyiv_dpa_retime_block data_clock_retime(
                                        .clkin(clkin),
                                        .datain(datain),
                                        .reset(dpareset),
                                        .clk0(clk0_tmp),
...
//               4) hardcopyiv_lvds_rx_deser
//               5) hardcopyiv_lvds_rx_parallel_reg
//               6) hardcopyiv_select_ini_phase_dpaclk
//               7)hardcopyiv_dpa_block
//               8) hardcopyiv_pclk_divider
//
//
///////////////////////////////////////////////////////////////////////////////
...
// SIMULATION_ONLY_PARAMETERS_END
 ...
 reg in_reg_data_dly;
   ...
   hardcopyiv_select_ini_phase_dpaclk ini_clk_phase_select(
                                                     .clkin(clk0),
 ...
 assign   ini_phase_select_enable = (enable_dpa_initial_phase_selection == "on") ? 1'b1 : 1'b0;
    ...
    hardcopyiv_dpa_block dpa_circuit(
                                .clkin(ini_dpa_clk),
                                .dpareset(dpa_rst),
                                .dpahold(dpahold),
                                .datain(dpareg1_out),
...
assign dpa_rst = ((enable_soft_cdr == "on")|| (enable_dpa == "on")) ? dpareset : 1'b0;
 ...
 hardcopyiv_pclk_divider  clk_forward(
                                 .clkin(dpa_clk),
                                 .lloaden(lloaden),
...
// FIFO
    hardcopyiv_lvds_rx_fifo    s_fifo (
                                  .wclk(dpa_clk),
                                  .rclk(fifo_rclk),
                                  .fiforst(fifo_reset),
                                  .dparst(dpa_rst),
...
// BIT SLIP
    hardcopyiv_lvds_rx_bitslip    s_bslip (
                                      .clk0(s_bitslip_clk),
                                      .bslipcntl(bitslip),
    ...
    // DESERIALISER
    hardcopyiv_lvds_reg rxload_reg (
                                .d(loaden),
                                .clk(s_bitslip_clk),
                                .ena(1'b1),
                                .clrn(1'b1),
    ...
    hardcopyiv_lvds_rx_deser    s_deser (
                                    .clk(s_bitslip_clk),
                                    .datain(slip_dataout),
                                    .devclrn(devclrn),
                                    .devpor(devpor),
    ...
    hardcopyiv_lvds_rx_parallel_reg  output_reg  (
                                             .clk(s_bitslip_clk),
                                             .enable(rxload),
...
// Deactivate the following LEDA rules for hardcopyiv_pseudo_diff_atom.v
// G_521_3B: Use uppercase letters for all parameter names
// leda G_521_3_B off
...
// -----------------------------------------------------------
//
// Module Name : hardcopyiv_bias_logic
//
...
endmodule // hardcopyiv_bias_logic

// -----------------------------------------------------------
//
// Module Name : hardcopyiv_bias_generator
//
// Description : HARDCOPYIV Bias Generator Verilog simulation model
//
// -----------------------------------------------------------
...
endmodule // hardcopyiv_bias_generator

// -----------------------------------------------------------
//
// Module Name : hardcopyiv_bias_block
//
// Description : HARDCOPYIV Bias Block Verilog simulation model
//
// -----------------------------------------------------------
...
hardcopyiv_bias_logic logic_block (
                             .clk(clk),
                             .shiftnld(shiftnld),
                             .captnupdt(captnupdt),
...
hardcopyiv_bias_generator bias_generator (
                                    .din(din),
                                    .mainclk(mainclk_wire),
                                    .updateclk(updateclk_wire),
                                    .capture(capture_wire),
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiv_lcell_hsadder
//
// Description : Hardcopy III High Speed Adder Verilog simulation model 
//
//------------------------------------------------------------------
...
////////////////////////////////////////////////////////////////////////////////////
//Module Name:            hardcopyiv_otp                                 
//Description:            Simulation model for HARDCOPYIII OTP (One Time Programmable)           
//                                                                              
////////////////////////////////////////////////////////////////////////////////////
