...
primitive ARRIAGX_PRIM_DFFE (Q, ENA, D, CLK, CLRN, PRN, notifier);
   input D;   
   input CLRN;
   input PRN;
   input CLK;
...
primitive ARRIAGX_PRIM_DFFEAS (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
...
primitive ARRIAGX_PRIM_DFFEAS_HIGH (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
    input d,clk,ena,clr,pre,ald,adt,sclr,sload, notifier;
    output q;
    reg q;
    initial
...
module arriagx_dffe ( Q, CLK, ENA, D, CLRN, PRN );
   input D;
   input CLK;
   input CLRN;
   input PRN;
   ...
   ARRIAGX_PRIM_DFFE ( Q, ENA_ipd, D_ipd, CLK_ipd, CLRN_ipd, PRN_ipd, viol_notifier );
...
module arriagx_mux41 (MO, IN0, IN1, IN2, IN3, S);
   input IN0;
   input IN1;
   input IN2;
   input IN3;
...
module arriagx_ram_pulse_generator (
                                    clk,
                                    ena,
                                    pulse,
                                    cycle
...
// port A active
arriagx_ram_register active_port_a (
        .d(active_a_in),
        .clk(clk_a_in),
        .aclr(1'b0),
        .devclrn(1'b1),
...
// port B active
arriagx_ram_register active_port_b (
        .d(active_b_in),
        .clk(clk_b_in),
        .aclr(1'b0),
        .devclrn(1'b1),
...
// ------- A input registers -------
// write enable
arriagx_ram_register we_a_register (
...
// address
arriagx_ram_register addr_a_register (
        .d(portaaddr_int),
        .clk(clk_a_in),
        .aclr(addr_a_clr_in),
...
// data
arriagx_ram_register datain_a_register (
        .d(portadatain_int),
        .clk(clk_a_in),
...
// byte enable
arriagx_ram_register byteena_a_register (
...
// read/write enable
arriagx_ram_register rewe_b_register (
        .d(portbrewe_int),
        .clk(clk_b_in),
        .aclr(rewe_b_clr_in),
 .stall(1'b0),
...
// address
arriagx_ram_register addr_b_register (
        .d(portbaddr_int),
        .clk(clk_b_in),
        .aclr(addr_b_clr_in),
        .devclrn(devclrn),
...
// data
arriagx_ram_register datain_b_register (
        .d(portbdatain_int),
        .clk(clk_b_in),
...
// byte enable
arriagx_ram_register byteena_b_register (
...
arriagx_ram_pulse_generator wpgen_a (
...
arriagx_ram_pulse_generator wpgen_b (
...
arriagx_ram_pulse_generator rpgen_a (
        .clk(clk_a_in),
...
arriagx_ram_pulse_generator rpgen_b (
        .clk(clk_b_in),
...
arriagx_ram_pulse_generator ftpgen_a (
        .clk(clk_a_in),
       .ena(active_a & ~mode_is_dp & we_a_reg),
        .pulse(read_pulse_a_feedthru),.cycle()
        );

arriagx_ram_pulse_generator ftpgen_b (
        .clk(clk_b_in),
...
arriagx_ram_register dataout_a_register (
        .d(dataout_a),
        .clk(clk_a_out),
        .aclr(dataout_a_clr),
        .devclrn(devclrn),
...
arriagx_ram_register dataout_b_register (
        .d( dataout_b ),
        .clk(clk_b_out),
        .aclr(dataout_b_clr),
        .devclrn(devclrn),.devpor(devpor),
...
//
// Description : StratixIIGXLITE JTAG Verilog Simulation model
//
//--------------------------------------------------------------------
...
//
// Description : StratixIIGXLITE CRCBLOCK Verilog Simulation model
//
//--------------------------------------------------------------------
...
//---------------------------------------------------------------------
//
// Module Name : arriagx_asmiblock
//
// Description : StratixIIGXLITEIIGXLITE ASMIBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
...
endmodule  // arriagx_asmiblock
//------------------------------------------------------------------
//
// Module Name : arriagx_lcell_ff
//
// Description : StratixIIGXLITE LCELL_FF Verilog simulation model 
//
//------------------------------------------------------------------
`timescale 1 ps/1 ps
...
//
// Description : StratixIIGXLITE LCELL_COMB Verilog simulation model 
//
//------------------------------------------------------------------

// Deactivate the following LEDA rules for arriagx_lcell_comb.v
   ...
   begin
    ...
    begin   
        ...
        begin
            ...
            begin
                $display ("Error: Invalid operation_mode specified in arriagx io atom!\n");
                $display ("Time: %0t  Instance: %m", $time);
            end
        end      
...
assign oe_clk_ena = (tie_off_oe_clock_enable == "false") ? outclkena : 1'b1;
   ...
   // in_ddio0_reg
   arriagx_io_register in_ddio0_reg (
   ...
   // out ddio reg
   arriagx_io_register out_ddio_reg (
   ...
   // oe_pulse reg
   arriagx_io_register oe_pulse_reg (
   ...
   arriagx_and1    sel_delaybuf (.Y(outclk_delayed), .IN1(outclk));
   
   arriagx_mux21   ddio_data_mux (
                          .MO (ddio_data),
                          .A (out_ddio_reg_out),
                          .B (out_reg_out),
                          .S (outclk_delayed)
...
//
// Description : Simulation model for StratixIIGXLITE DLL block
//
...
//
// Description : StratixIIGXLITE CLKCTRL Verilog simulation model 
//
//------------------------------------------------------------------
...
arriagx_mux41 clk_mux (.MO(clkmux_out),
               .IN0(inclk0_ipd),
               .IN1(inclk1_ipd),
               .IN2(inclk2_ipd),
               .IN3(inclk3_ipd),
...
endmodule // arriagx_lvds_tx_reg

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriagx_lvds_tx_parallel_register
//
...
`timescale 1 ps/1 ps
module arriagx_lvds_tx_parallel_register (clk,
                                            enable,
                                            datain,
                                            dataout,
                                            devclrn,
...
endmodule //arriagx_lvds_tx_parallel_register

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriagx_lvds_tx_out_block
//
...
`timescale 1 ps/1 ps
module arriagx_lvds_tx_out_block (clk,
                                    datain,
                                    dataout,
                                    devclrn,
                                    devpor
...
endmodule //arriagx_lvds_tx_out_block
...
`timescale 1 ps/1 ps
module arriagx_lvds_transmitter (clk0,
                                   enable0,
                                   datain,
                                   serialdatain,
                                   postdpaserialdatain,
...
// SIMULATION_ONLY_PARAMETERS_END
    ...
    arriagx_lvds_tx_reg txload0_reg (.d(enable0),
                             .clrn(1'b1),
                             .prn(1'b1),
                             .ena(1'b1),
                             .clk(clk0_in),
    ...
    arriagx_lvds_tx_out_block output_module (.clk(clk0_in),
                                               .datain(shift_out),
                                               .dataout(dataout_tmp),
                                               .devclrn(devclrn),
                                               .devpor(devpor)
    ...
    arriagx_lvds_tx_parallel_register input_reg (.clk(txload0),
                                                   .enable(1'b1),
                                                   .datain(datain_dly),
                                                   .dataout(input_data),
                                                   .devclrn(devclrn),
...
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriagx_m_cntr
//
// Description : Timing simulation model for the M counter. This is the
//               loop feedback counter for the StratixIIGXLITE PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // arriagx_m_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriagx_n_cntr
//
// Description : Timing simulation model for the N counter. This is the
//               input clock divide counter for the StratixIIGXLITE PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // arriagx_n_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriagx_scale_cntr
//
// Description : Timing simulation model for the output scale-down counters.
//               This is a common model for the C0, C1, C2, C3, C4 and
//               C5 output counters of the StratixIIGXLITE PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // arriagx_scale_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : arriagx_pll_reg
//
// Description : Simulation model for a simple DFF.
...
// SIMULATION_ONLY_PARAMETERS_BEGIN
    ...
    parameter family_name = "StratixIIGXLITE";
...
// LOCAL_PARAMETERS_END
    ...
    arriagx_pll_reg ena_reg ( .clk(!inclk_n),
                                .ena(1'b1),
                                .d(ena_ipd),
                                .clrn(1'b1),
                                .prn(1'b1),
    ...
    arriagx_n_cntr n1 (.clk(n_cntr_inclk),
                        .reset(areset_ipd),
                        .cout(refclk),
                        .modulus(n_val[0]));
    ...
    arriagx_scale_cntr c0 (.clk(inclk_c0),
                            .reset(areset_ipd || (!ena_pll) || stop_vco),
                            .cout(c0_clk),
                            .high(c_high_val[0]),
                            .low(c_low_val[0]),
    ...
    arriagx_scale_cntr c1 (.clk(inclk_c1),
                            .reset(areset_ipd || (!ena_pll) || stop_vco),
                            .cout(c1_clk),
                            .high(c_high_val[1]),
                            .low(c_low_val[1]),
    ...
    arriagx_scale_cntr c2 (.clk(inclk_c2),
                            .reset(areset_ipd || (!ena_pll) || stop_vco),
                            .cout(c2_clk),
                            .high(c_high_val[2]),
                            .low(c_low_val[2]),
    ...
    arriagx_scale_cntr c3 (.clk(inclk_c3),
                            .reset(areset_ipd || (!ena_pll) || stop_vco),
                            .cout(c3_clk),
                            .high(c_high_val[3]),
                            .low(c_low_val[3]),
    ...
    arriagx_scale_cntr c4 (.clk(inclk_c4),
                            .reset(areset_ipd || (!ena_pll) || stop_vco),
                            .cout(c4_clk),
                            .high(c_high_val[4]),
                            .low(c_low_val[4]),
    ...
    arriagx_scale_cntr c5 (.clk(inclk_c5),
                            .reset(areset_ipd || (!ena_pll) || stop_vco),
                            .cout(c5_clk),
                            .high(c_high_val[5]),
                            .low(c_low_val[5]),
...
///////////////////////////////////////////////////////////////////////////////
//
//                      arriagx_MAC_MULT_BLOCK
//
///////////////////////////////////////////////////////////////////////////////

`timescale 1 ps/1 ps
module arriagx_mac_mult_block (
                                 dataa,
                                 datab,
                                 signa,
                                 signb,
...
arriagx_mac_register dataa_input_register (
                                             .datain(dataa_in),
                                             .clk(dataa_clk),
                                             .aclr(dataa_aclr),
                                             .ena(dataa_ena),
...
arriagx_mac_register datab_input_register (
                                             .datain(datab_in),
                                             .clk(datab_clk),
                                             .aclr(datab_aclr),
                                             .ena(datab_ena),
...
arriagx_mac_register signa_input_register (
                                             .datain(signa),
                                             .clk(signa_clk),
                                             .aclr(signa_aclr),
                                             .ena(signa_ena),
...
arriagx_mac_register signb_input_register (
                                             .datain(signb),
                                             .clk(signb_clk),
                                             .aclr(signb_aclr),
                                             .ena(signb_ena),
...
arriagx_mac_register round_input_register (
                                             .datain(round),
                                             .clk(round_clk),
                                             .aclr(round_aclr),
                                             .ena(round_ena),
...
arriagx_mac_register saturate_input_register (
                                             .datain(saturate),
                                             .clk(saturate_clk),
                                             .aclr(saturate_aclr),
                                             .ena(saturate_ena),
...
arriagx_mac_register mode_input_register (                            
                                            .datain(mode),                 
                                            .clk(mode_clk),                
                                            .aclr(mode_aclr),              
                                            .ena(mode_ena),                
...
arriagx_mac_register zeroacc_input_register (                             
                                             .datain(zeroacc),                  
                                             .clk(zeroacc_clk),                 
                                             .aclr(zeroacc_aclr),                   
                                             .ena(zeroacc_ena),                     
...
arriagx_mac_mult_block mac_multiplier (
                                         .dataa(dataa_in_reg),
                                         .datab(datab_in_reg),
                                         .signa(signa_mult),
                                         .signb(signb_mult),
...
arriagx_mac_rs_block mac_rs_block(
                                    .operation(4'b1111),
                                    .round(round_in_reg),
...
arriagx_mac_register mult_output_register(
...
///////////////////////////////////////////////////////////////////////////////
//
//                         arriagx_MAC_OUT_Input_Interface
//
///////////////////////////////////////////////////////////////////////////////


module  arriagx_mac_out_input_interface(
                                           accuma,
                                           accumc,
                                           dataa,
                                           datab,
...
///////////////////////////////////////////////////////////////////////////////
//
//                         arriagx_MAC_OUT_ADD_SUB_ACC_UNIT
//
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
//
//                         arriagx_MAC_OUT_Output_Interface
//
///////////////////////////////////////////////////////////////////////////////

  module arriagx_mac_out_output_interface(
                                             dataa,
                                             datab,
                                             datac,
                                             datad,
...
///////////////////////////////////////////////////////////////////////////////
//
//                          arriagx_MAC_OUT_Internal_Logic
//
///////////////////////////////////////////////////////////////////////////////

`timescale 1 ps/1 ps

  module arriagx_mac_out_internal (
                                      dataa,
                                      datab,
                                      datac,
                                      datad,
...
assign   operation = (operation_mode == "output_only") ? 4'b0000 :
 ...
 //Assign the sign size depending on the mode of operation
   ...
   //Instantiate arriagx_Input_Interface
arriagx_mac_out_input_interface input_interface(
                                                  .accuma(iib_accuma),
                                                  .accumc(iib_accumc),
                                                  .dataa(iib_dataa),
                                                  .datab(iib_datab),
...
arriagx_mac_out_add_sub_acc_unit block_r(
                                           .dataa(iib_outa),
                                           .datab(iib_outb),
                                           .datac(iib_outc),
                                           .datad(iib_outd),
...
arriagx_mac_out_add_sub_acc_unit block_s(
                                           .dataa(iib_outa),
                                           .datab(iib_outb),
                                           .datac(iib_outc),
                                           .datad(iib_outd),
...
defparam   block_s.block_type  = "S";
 ...
 arriagx_mac_rs_block mac_rs_rb(
                                  .operation(operation),
                                  .round(roundab),
                                  .saturate(saturateab),
                                  .addnsub(addnsub0),
...
arriagx_mac_rs_block mac_rs_sb(
                                 .operation(operation),
                                 .round(roundcd),
                                 .saturate(saturatecd),
                                 .addnsub(addnsub1),
...
arriagx_mac_out_add_sub_acc_unit block_t(
                                            .dataa(rs_rb_dataout),
                                            .datab(rs_sb_dataout),
                                            .datac(iib_outc),
                                            .datad(iib_outd),
...
arriagx_mac_out_output_interface output_interface(
                                                    .dataa(oib_dataa),
                                                    .datab(oib_datab),
                                                    .datac(oib_datac),
                                                    .datad(oib_datad),
...
arriagx_reorder_output reorder_unit(
                                      .datain(oib_dataout),
                                      .addnsub(ro_addnsub),
                                      .operation(operation),
                                      .dataout(dataout_tmp)
...
arriagx_mac_register  signa_inreg(
                                    .datain(signa),
                                    .clk(signa_inreg_clk),
...
arriagx_mac_register  signa_pipreg(
...
arriagx_mac_register  signb_inreg(
                                    .datain(signb),
                                    .clk(signb_inreg_clk),
...
arriagx_mac_register  signb_pipreg(
...
arriagx_mac_register  zeroacc_inreg(
                                      .datain(zeroacc),
...
arriagx_mac_register  zeroacc_pipreg(
...
arriagx_mac_register  zeroacc1_inreg (                            
                                         .datain(zeroacc1), 
...
arriagx_mac_register  zeroacc1_pipreg(
...
arriagx_mac_register  addnsub0_inreg(
                                       .datain(addnsub0),
...
arriagx_mac_register  addnsub0_pipreg(
...
arriagx_mac_register  addnsub1_inreg(
                                       .datain(addnsub1),
...
arriagx_mac_register  addnsub1_pipreg(
...
arriagx_mac_register  round0_inreg(
                                     .datain(round0),
...
arriagx_mac_register  round0_pipreg(
...
arriagx_mac_register  round1_inreg(
                                     .datain(round1),
...
arriagx_mac_register  round1_pipreg(
...
arriagx_mac_register  saturate_inreg(
                                       .datain(saturate),
...
arriagx_mac_register  saturate_pipreg(
...
arriagx_mac_register  saturate1_inreg(
                                        .datain(saturate1), 
...
arriagx_mac_register  saturate1_pipreg(           
...
arriagx_mac_register  mode0_inreg(      
                                    .datain(mode0), 
                                    .clk(mode0_inreg_clk), 
...
arriagx_mac_register  mode0_pipreg(
...
arriagx_mac_register  mode1_inreg (
                                     .datain(mode1), 
                                     .clk(mode1_inreg_clk), 
...
arriagx_mac_register  mode1_pipreg (
...
arriagx_mac_register  multabsaturate_inreg(
...
arriagx_mac_register  multabsaturate_pipreg(
...
arriagx_mac_register  multcdsaturate_inreg(
...
arriagx_mac_register  multcdsaturate_pipreg(
...
arriagx_mac_out_internal mac_out_block(
                                         .dataa(mac_out_dataa),
                                         .datab(mac_out_datab),
                                         .datac(mac_out_datac),
                                         .datad(mac_out_datad),
...
arriagx_mac_register  output_register(
...
arriagx_mac_register  accoverflow_register(
...
arriagx_mac_register  output_register1(                                                      
...
arriagx_mac_register  output_register2(                                                      
...
arriagx_mac_register  output_register3(                                                      
...
arriagx_mac_register  output_register4(                                                      
...
arriagx_mac_register  output_register5(                                                      
...
arriagx_mac_register  output_register6(                                                      
...
arriagx_mac_register  output_register7(                                                      
...
`timescale 1 ps/1 ps
module arriagx_lvds_rx_fifo (wclk, 
                               rclk, 
                               dparst,
                               fiforst, 
                               datain, 
    ...
    arriagx_lvds_rx_fifo_sync_ram  s_fifo_ram (.clk(wclk_in),
                                                 .datain(ram_datain),
...
endmodule // arriagx_lvds_rx_fifo
...
`timescale 1 ps/1 ps
module arriagx_lvds_rx_bitslip (clk0, 
                                  bslipcntl, 
                                  bsliprst, 
                                  datain, 
                                  bslipmax, 
    ...
    arriagx_lvds_reg bslipcntlreg (.d(bslipcntl_in),
                           .clk(clk0_in),
                           .ena(1'b1),
                           .clrn(!bsliprst_in),
                           .prn(1'b1),
    ...
    arriagx_lvds_reg dataoutreg (.d(bitslip_arr[slip_count]),
                         .clk(clk0_in),
                         .ena(1'b1),
                         .clrn(1'b1),
                         .prn(1'b1),
...
endmodule // arriagx_lvds_rx_bitslip
...
`timescale 1 ps/1 ps
module arriagx_lvds_rx_deser (clk,
                                datain,
                                devclrn,
                                devpor,
                                dataout
...
endmodule //arriagx_lvds_rx_deser
...
`timescale 1 ps/1 ps
module arriagx_lvds_rx_parallel_reg (clk, 
                                       enable, 
                                       datain, 
                                       dataout, 
//                                       reset,
...
endmodule //arriagx_lvds_rx_parallel_reg
...
//               4) arriagx_lvds_rx_deser
//               5) arriagx_lvds_rx_parallel_reg
//
///////////////////////////////////////////////////////////////////////////////

`timescale 1 ps/1 ps

module arriagx_lvds_receiver (clk0,
                                datain,
                                enable0,
                                dpareset,
                                dpahold,
...
// LOCAL_PARAMETERS_END
    ...
    begin
        ...
        if (enable_dpa == "on")
        begin
            $display("Warning : DPA Phase tracking is not modeled and once locked, DPA will continue to lock until the next reset is asserted. Please refer to the StratixIIGXLITE device handbook for further details.");
            $display("Time: %0t, Instance: %m", $time);
        end
    end
    ...
    arriagx_lvds_reg in_reg (.d(in_reg_data),
                     .clk(clk0_in),
                     .ena(1'b1),
                     .clrn(devclrn || devpor),
                     .prn(1'b1),
   ...
   assign dpa_clk = (enable_dpa == "on") ? clk0_in : 1'b0;
    ...
    // DPA registers
    arriagx_lvds_reg dpareg0 (.d(in_reg_data),
                     .clk(dpa_clk),
                     .clrn(1'b1),
                     .prn(1'b1),
                     .ena(1'b1),
    ...
    arriagx_lvds_reg dpareg1 (.d(dpareg0_out),
                     .clk(dpa_clk),
                     .clrn(1'b1),
                     .prn(1'b1),
                     .ena(1'b1),
    ...
    arriagx_lvds_rx_fifo    s_fifo (.wclk(fifo_wclk),
                                      .rclk(fifo_rclk),
                                      .fiforst(fifo_reset),
                                      .dparst(dpa_rst),
                                      .datain(fifo_datain),
  ...
  assign slip_datain = slip_datain_tmp; 
    ...
    arriagx_lvds_rx_bitslip    s_bslip (.clk0(s_bitslip_clk),
 ...
 assign loaden = enable0_in; 
    ...
    arriagx_lvds_reg rxload_reg (.d(loaden),
                     .clk(s_bitslip_clk),
                     .ena(1'b1),
                     .clrn(1'b1),
                     .prn(1'b1),
    ...
    arriagx_lvds_rx_deser    s_deser (.clk(s_bitslip_clk),
                                        .datain(slip_dataout),
                                        .devclrn(devclrn),
                                        .devpor(devpor),
    ...
    arriagx_lvds_rx_parallel_reg  output_reg  (.clk(s_bitslip_clk),
                                               .enable(rxload),
...
//------------------------------------------------------------------
//
// Module Name : arriagx_termination_digital
//
// Description : Simualtion model for digital portion of 
//               StratixIIGXLITE Calibration Block 
//
...
//
// Description : StratixIIGXLITE Termination Atom Verilog simulation model 
//
// ** Note **  : Termination calibration block does not have
//               digital outputs that are observable in PLD by
//               users. The model below is for internal verification.
...
arriagx_termination_digital rup_block(
    .rin(incrup_out),
    .clk(clock_in),
    .clr(clear_in),
    .ena(ena1),
...
arriagx_termination_digital rdn_block(
    .rin(incrdn_out),
    .clk(clock_in),
    .clr(clear_in),
    .ena(ena1),
...
//------------------------------------------------------------------
//
// Module Name : arriagx_routing_wire
//
...
endmodule // arriagx_routing_wire
