...
primitive HARDCOPYIII_PRIM_DFFE (Q, ENA, D, CLK, CLRN, PRN, notifier);
   input D;   
   input CLRN;
   input PRN;
   input CLK;
...
primitive HARDCOPYIII_PRIM_DFFEAS (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
...
primitive HARDCOPYIII_PRIM_DFFEAS_HIGH (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
    input d,clk,ena,clr,pre,ald,adt,sclr,sload, notifier;
    output q;
    reg q;
    initial
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiii_lcell_comb
//
// Description : HARDCOPYIII LCELL_COMB Verilog simulation model 
//
//------------------------------------------------------------------

// Deactivate the following LEDA rules for hardcopyiii_lcell_comb.v
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiii_routing_wire
//
...
endmodule // hardcopyiii_routing_wire
///////////////////////////////////////////////////////////////////////////////
//
...
endmodule // hardcopyiii_lvds_tx_reg

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiii_lvds_tx_parallel_register
//
...
endmodule //hardcopyiii_lvds_tx_parallel_register

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiii_lvds_tx_out_block
//
...
endmodule //hardcopyiii_lvds_tx_out_block

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiii_lvds_transmitter
//
...
endmodule // hardcopyiii_lvds_transmitter
...
//--------------------------------------------------------------------------
// Module Name     : hardcopyiii_ram_block
...
endmodule // hardcopyiii_ram_block
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiii_ff
//
// Description : HARDCOPYIII FF Verilog simulation model 
//
//------------------------------------------------------------------
`timescale 1 ps/1 ps
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiii_clkselect
//
// Description : HARDCOPYIII CLKSELECT Verilog simulation model 
//
//------------------------------------------------------------------
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiii_and2
//
// Description : Simulation model for a simple 2-inputs AND gate.
//               This is used for the storing delays for HARDCOPYIII CLKENA.
//
//------------------------------------------------------------------
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiii_ena_reg
//
// Description : Simulation model for a simple DFF.
...
endmodule // hardcopyiii_ena_reg

//------------------------------------------------------------------
//
// Module Name : hardcopyiii_clkena
//
// Description : HARDCOPYIII CLKENA Verilog simulation model 
//
//------------------------------------------------------------------
...
//--------------------------------------------------------------------------
// Module Name     : hardcopyiii_hram_pulse_generator
// Description     : Generate pulse to initiate memory read/write operations
//--------------------------------------------------------------------------
`timescale 1 ps/1 ps
...
endmodule // hardcopyiii_hram
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    hardcopyiii_io_ibuf                                 //
//Description:                    Simulation model for HARDCOPYIII IO Input Buffer    //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

// Deactivate the following LEDA rules for hardcopyiii_io_atom.v
// G_521_3B: Use uppercase letters for all parameter names
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    hardcopyiii_io_obuf                                 //
//Description:                    Simulation model for HARDCOPYIII IO Output Buffer   //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
//Description:                    Simulation model for HARDCOPYIII DDIO Output        //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    hardcopyiii_ddio_oe                                 //
//Description:                    Simulation model for HARDCOPYIII DDIO OE            //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//Module Name:                    hardcopyiii_ddio_in                                 
//Description:                    Simulation model for HARDCOPYIII DDIO IN            
//                                                                              
////////////////////////////////////////////////////////////////////////////////
...
//                              1.hardcopyiii_mac_register.                           //
//                              2.hardcopyiii_mac_multiplier.                         //
//////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////
//  Module Name:             hardcopyiii_saturation_block                                             //
...
//  Description:             HARDCOPYIII rotate and shift Unit.                                       //
//////////////////////////////////////////////////////////////////////////////////////////////////
...
//  Description:             HARDCOPYIII carry chain adder Unit.                                      //
//////////////////////////////////////////////////////////////////////////////////////////////////
...
// begin_ddr
//-----------------------------------------------------------------------------
// Module Name: hardcopyiii_ddr_gray_decoder
...
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
module hardcopyiii_ddr_delay_chain_s (
        clk, 
        delayctrlin, 
        phasectrlin, 
        delayed_clkout
...
hardcopyiii_ddr_gray_decoder m_delayctrl_in_dec(delayctrlin_in, delayctrl_bin);
...
//-----------------------------------------------------------------------------
// Module Name: hardcopyiii_ddr_io_reg
...
//-----------------------------------------------------------------------------
//
// Module Name : hardcopyiii_dll
//
// Description : HARDCOPYIII Delay Locked Loop 
...
endmodule    // hardcopyiii_dll

//-----------------------------------------------------------------------------
//
// Module Name : hardcopyiii_offset_ctrl
//
// Description : HARDCOPYIII Delay Locked Loop Offset Control 
//               Verilog simulation model 
//
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
...
begin
...
endmodule    // hardcopyiii_offset_ctrl

 //-----------------------------------------------------------------------------
 //
 // Module Name : hardcopyiii_dqs_delay_chain
 //
 // Description : HARDCOPYIII DQS Delay Chain (within DQS I/O) 
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
 ...
 endmodule    // hardcopyiii_dqs_delay_chain
 
 
//-----------------------------------------------------------------------------
//
// Module Name : hardcopyiii_dqs_enable
//
// Description : HARDCOPYIII DQS Enable 
//               Verilog simulation model 
//
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
...
pmos (dqsbusout, tmp_dqsbusout, 1'b0);
...
endmodule    // hardcopyiii_dqs_enable


 //-----------------------------------------------------------------------------
 //
 // Module Name : hardcopyiii_dqs_enable_ctrl
 //
 // Description : HARDCOPYIII DQS Enable Control
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
 ...
 endmodule    // hardcopyiii_dqs_enable_ctrl
 
 
 //-----------------------------------------------------------------------------
 //
 // Module Name : hardcopyiii_delay_chain
 //
 // Description : HARDCOPYIII Delay Chain (dynamic adjustable delay chain) 
 //               Verilog simulation model 
 //
 //-----------------------------------------------------------------------------
 `timescale 1 ps/1 ps
 ...
 endmodule    // hardcopyiii_delay_chain
 
 
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiii_io_clock_divider
  //
  // Description : HARDCOPYIII I/O Clock Divider 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
 ...
 // LOCAL_PARAMETERS_END
  ...
  endmodule    // hardcopyiii_io_clock_divider
  
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiii_output_phase_alignment
  //
 ...
 // Duty Cycle Delay
  ...
  endmodule    // hardcopyiii_output_phase_alignment
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiii_input_phase_alignment
  //
 ...
 // LOCAL_PARAMETERS_END
  ...
  endmodule    // hardcopyiii_input_phase_alignment
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiii_half_rate_input
  //
  // Description : HARDCOPYIII half rate input 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
  ...
  endmodule    // hardcopyiii_half_rate_input
  
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiii_io_config
  //
  // Description : HARDCOPYIII I/O Configuration Register 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
  ...
  endmodule    // hardcopyiii_io_config
  
  //-----------------------------------------------------------------------------
  //
  // Module Name : hardcopyiii_dqs_config
  //
  // Description : HARDCOPYIII DQS Configuration Register 
  //               Verilog simulation model 
  //
  //-----------------------------------------------------------------------------
  `timescale 1 ps/1 ps
  ...
  endmodule    // hardcopyiii_dqs_config
...
parameter HARDCOPYIII_RTOCT_WAIT         = 5'b00000;
...
parameter HARDCOPYIII_RTOCT_INC_PN       = 5'b01000;
parameter HARDCOPYIII_RTOCT_DEC_PN       = 5'b01001;
parameter HARDCOPYIII_RTOCT_INC_P        = 5'b01010;
parameter HARDCOPYIII_RTOCT_DEC_P        = 5'b01011;
parameter HARDCOPYIII_RTOCT_INC_N        = 5'b01100;
parameter HARDCOPYIII_RTOCT_DEC_N        = 5'b01101;
parameter HARDCOPYIII_RTOCT_SWITCH_REG   = 5'b10001;
parameter HARDCOPYIII_RTOCT_DONE         = 5'b11111;
...
begin
    ...
    HARDCOPYIII_RTOCT_INC_P,HARDCOPYIII_RTOCT_DEC_P,HARDCOPYIII_RTOCT_INC_N,HARDCOPYIII_RTOCT_DEC_N :
...
endmodule    // hardcopyiii_termination
...
endmodule    // hardcopyiii_termination_logic
//--------------------------------------------------------------------------
...
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiii_m_cntr
//
// Description : Timing simulation model for the M counter. This is the
//               loop feedback counter for the HARDCOPYIII PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // hardcopyiii_m_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiii_n_cntr
//
// Description : Timing simulation model for the N counter. This is the
//               input clock divide counter for the HARDCOPYIII PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // hardcopyiii_n_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiii_scale_cntr
//
...
endmodule // hardcopyiii_scale_cntr

//BEGIN MF PORTING DELETE
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiii_pll_reg
//
// Description : Simulation model for a simple DFF.
...
endmodule // hardcopyiii_pll_reg
//END MF PORTING DELETE

//////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyiii_pll
//
...
endmodule // hardcopyiii_pll
//---------------------------------------------------------------------
//
// Module Name : hardcopyiii_asmiblock
//
// Description : HARDCOPYIII ASMIBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
...
endmodule  // hardcopyiii_asmiblock
//---------------------------------------------------------------------
//
// Module Name : hardcopyiii_tsdblock
//
// Description : HARDCOPYIII TSDBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
...
endmodule  // hardcopyiii_tsdblock
///////////////////////////////////////////////////////////////////////////////
//
...
endmodule // hardcopyiii_lvds_rx_fifo
...
endmodule // hardcopyiii_lvds_rx_bitslip
...
endmodule //hardcopyiii_lvds_rx_deser
...
endmodule //hardcopyiii_lvds_rx_parallel_reg
...
endmodule // hardcopyiii_lvds_reg
...
module hardcopyiii_dpa_block(clkin,
                dpareset,
                dpahold,
                datain,
                clkout,
...
hardcopyiii_dpa_retime_block data_clock_retime(
                                        .clkin(clkin),
                                        .datain(datain),
                                        .reset(dpareset),
                                        .clk0(clk0_tmp),
...
//               4) hardcopyiii_lvds_rx_deser
//               5) hardcopyiii_lvds_rx_parallel_reg
//               6) hardcopyiii_select_ini_phase_dpaclk
//               7)hardcopyiii_dpa_block
//               8) hardcopyiii_pclk_divider
//
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // hardcopyiii_lvds_receiver
//////////////////////////////////////////////////////////////////////////////////
...
// Deactivate the following LEDA rules for hardcopyiii_pseudo_diff_atom.v
// G_521_3B: Use uppercase letters for all parameter names
// leda G_521_3_B off
...
// -----------------------------------------------------------
//
// Module Name : hardcopyiii_bias_logic
//
...
endmodule // hardcopyiii_bias_logic

// -----------------------------------------------------------
//
// Module Name : hardcopyiii_bias_generator
//
// Description : HARDCOPYIII Bias Generator Verilog simulation model
//
// -----------------------------------------------------------
...
endmodule // hardcopyiii_bias_generator

// -----------------------------------------------------------
//
// Module Name : hardcopyiii_bias_block
//
// Description : HARDCOPYIII Bias Block Verilog simulation model
//
// -----------------------------------------------------------
...
endmodule // hardcopyiii_bias_block

//--------------------------------------------------------------------
//
// Module Name : hardcopyiii_jtag
//
// Description : Hcx JTAG Verilog Simulation model
//
//--------------------------------------------------------------------
...
//------------------------------------------------------------------
//
// Module Name : hardcopyiii_lcell_hsadder
//
