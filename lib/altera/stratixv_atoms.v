...
module    stratixv_dqs_enable_ctrl    (
    ...
    coredqsmultirankdelayctrlin,
    rankselectreadin,
    coredqsenabledelayctrlout,    
    coredqsdisablendelayctrlout,  
    coredqsmultirankdelayctrlout,
    rankselectreadout, 
    dffphasetransfer,
    dffextenddqsenable,
    dqsenableout,
    ...
    stratixv_dqs_enable_ctrl_encrypted inst (
        ...
        .coredqsmultirankdelayctrlout(coredqsmultirankdelayctrlout),
...
module    stratixv_duty_cycle_adjustment    (
    ...
    parameter    dca_config_static_delayctrl_setting    =    0;
    ...
    defparam inst.dca_config_static_delayctrl_setting = dca_config_static_delayctrl_setting;
    defparam inst.lpm_type = lpm_type;
