...
primitive HARDCOPYII_PRIM_DFFE (Q, ENA, D, CLK, CLRN, PRN, notifier);
   input D;   
   input CLRN;
   input PRN;
   input CLK;
...
primitive HARDCOPYII_PRIM_DFFEAS (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
...
primitive HARDCOPYII_PRIM_DFFEAS_HIGH (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
    input d,clk,ena,clr,pre,ald,adt,sclr,sload, notifier;
    output q;
    reg q;
    initial
...
//------------------------------------------------------------------
//
// Module Name : hardcopyii_routing_wire
//
...
endmodule // hardcopyii_routing_wire
//--------------------------------------------------------------------
//
// Module Name : hardcopyii_jtag
//
// Description : HardCopy II JTAG Verilog Simulation model
//
//--------------------------------------------------------------------
...
//--------------------------------------------------------------------
//
// Module Name : hardcopyii_crcblock
//
// Description : HardCopy II CRCBLOCK Verilog Simulation model
//
//--------------------------------------------------------------------
...
//
// Description : HardCopy II LCELL_FF Verilog simulation model 
//
//------------------------------------------------------------------
`timescale 1 ps/1 ps
...
//
// Description : HardCopy II LCELL_COMB Verilog simulation model 
//
//------------------------------------------------------------------

// Deactivate the following LEDA rules for hardcopyii_lcell_comb.v
...
//
// Description : HardCopy II CLKCTRL Verilog simulation model 
//
//------------------------------------------------------------------
...
endmodule // hardcopyii_lvds_tx_reg

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyii_lvds_tx_parallel_register
//
...
endmodule //hardcopyii_lvds_tx_parallel_register

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyii_lvds_tx_out_block
//
...
endmodule //hardcopyii_lvds_tx_out_block
...
endmodule // hardcopyii_m_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyii_n_cntr
//
...
endmodule // hardcopyii_n_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyii_scale_cntr
//
...
endmodule // hardcopyii_scale_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : hardcopyii_pll_reg
//
// Description : Simulation model for a simple DFF.
...
///////////////////////////////////////////////////////////////////////////////
//
//                         hardcopyii_MAC_OUT_Input_Interface
//
///////////////////////////////////////////////////////////////////////////////


module  hardcopyii_mac_out_input_interface(
                                           accuma,
                                           accumc,
                                           dataa,
                                           datab,
...
///////////////////////////////////////////////////////////////////////////////
//
//                         hardcopyii_MAC_OUT_ADD_SUB_ACC_UNIT
//
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
//
//                         hardcopyii_MAC_OUT_Output_Interface
//
///////////////////////////////////////////////////////////////////////////////

  module hardcopyii_mac_out_output_interface(
                                             dataa,
                                             datab,
                                             datac,
                                             datad,
...
///////////////////////////////////////////////////////////////////////////////
//
//                          hardcopyii_MAC_OUT_Internal_Logic
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // hardcopyii_lvds_rx_fifo
...
endmodule // hardcopyii_lvds_rx_bitslip
...
endmodule //hardcopyii_lvds_rx_deser
...
endmodule //hardcopyii_lvds_rx_parallel_reg
...
//               4) hardcopyii_lvds_rx_deser
//               5) hardcopyii_lvds_rx_parallel_reg
//
///////////////////////////////////////////////////////////////////////////////
...
//------------------------------------------------------------------
//
// Module Name : hardcopyii_termination_digital
//
// Description : Simualtion model for digital portion of 
//               HardCopy II Calibration Block 
//
...
//
// Description : HardCopy II Termination Atom Verilog simulation model 
//
// ** Note **  : Termination calibration block does not have
//               digital outputs that are observable in PLD by
//               users. The model below is for internal verification.
...
//
// Description : Hardcopy II High Speed Adder Verilog simulation model 
//
//------------------------------------------------------------------
