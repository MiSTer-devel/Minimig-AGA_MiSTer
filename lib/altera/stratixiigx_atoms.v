...
primitive STRATIXIIGX_PRIM_DFFE (Q, ENA, D, CLK, CLRN, PRN, notifier);
   input D;   
   input CLRN;
   input PRN;
   input CLK;
...
primitive STRATIXIIGX_PRIM_DFFEAS (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
...
primitive STRATIXIIGX_PRIM_DFFEAS_HIGH (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
    input d,clk,ena,clr,pre,ald,adt,sclr,sload, notifier;
    output q;
    reg q;
    initial
...
//
// Description : StratixIIGX JTAG Verilog Simulation model
//
//--------------------------------------------------------------------
...
//
// Description : StratixIIGX CRCBLOCK Verilog Simulation model
//
//--------------------------------------------------------------------
...
//---------------------------------------------------------------------
//
// Module Name : stratixiigx_asmiblock
//
// Description : StratixIIGXIIGX ASMIBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
...
//
// Description : StratixIIGX LCELL_FF Verilog simulation model 
//
//------------------------------------------------------------------
`timescale 1 ps/1 ps
...
//
// Description : StratixIIGX LCELL_COMB Verilog simulation model 
//
//------------------------------------------------------------------

// Deactivate the following LEDA rules for stratixiigx_lcell_comb.v
...
//
// Description : Simulation model for StratixIIGX DLL block
//
...
//
// Description : StratixIIGX CLKCTRL Verilog simulation model 
//
//------------------------------------------------------------------
...
endmodule // stratixiigx_lvds_tx_reg

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : stratixiigx_lvds_tx_parallel_register
//
...
endmodule //stratixiigx_lvds_tx_parallel_register

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : stratixiigx_lvds_tx_out_block
//
...
endmodule //stratixiigx_lvds_tx_out_block
...
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : stratixiigx_m_cntr
//
// Description : Timing simulation model for the M counter. This is the
//               loop feedback counter for the StratixIIGX PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // stratixiigx_m_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : stratixiigx_n_cntr
//
// Description : Timing simulation model for the N counter. This is the
//               input clock divide counter for the StratixIIGX PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // stratixiigx_n_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : stratixiigx_scale_cntr
//
// Description : Timing simulation model for the output scale-down counters.
//               This is a common model for the C0, C1, C2, C3, C4 and
//               C5 output counters of the StratixIIGX PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // stratixiigx_scale_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : stratixiigx_pll_reg
//
// Description : Simulation model for a simple DFF.
...
///////////////////////////////////////////////////////////////////////////////
//
//                         stratixiigx_MAC_OUT_Input_Interface
//
///////////////////////////////////////////////////////////////////////////////


module  stratixiigx_mac_out_input_interface(
                                           accuma,
                                           accumc,
                                           dataa,
                                           datab,
...
///////////////////////////////////////////////////////////////////////////////
//
//                         stratixiigx_MAC_OUT_ADD_SUB_ACC_UNIT
//
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
//
//                         stratixiigx_MAC_OUT_Output_Interface
//
///////////////////////////////////////////////////////////////////////////////

  module stratixiigx_mac_out_output_interface(
                                             dataa,
                                             datab,
                                             datac,
                                             datad,
...
///////////////////////////////////////////////////////////////////////////////
//
//                          stratixiigx_MAC_OUT_Internal_Logic
//
///////////////////////////////////////////////////////////////////////////////
...
endmodule // stratixiigx_lvds_rx_fifo
...
endmodule // stratixiigx_lvds_rx_bitslip
...
endmodule //stratixiigx_lvds_rx_deser
...
endmodule //stratixiigx_lvds_rx_parallel_reg
...
endmodule // stratixiigx_lvds_reg
...
//               4) stratixiigx_lvds_rx_deser
//               5) stratixiigx_lvds_rx_parallel_reg
//
///////////////////////////////////////////////////////////////////////////////
...
//------------------------------------------------------------------
//
// Module Name : stratixiigx_termination_digital
//
// Description : Simualtion model for digital portion of 
//               StratixIIGX Calibration Block 
//
...
//
// Description : StratixIIGX Termination Atom Verilog simulation model 
//
// ** Note **  : Termination calibration block does not have
//               digital outputs that are observable in PLD by
//               users. The model below is for internal verification.
...
//------------------------------------------------------------------
//
// Module Name : stratixiigx_routing_wire
//
...
endmodule // stratixiigx_routing_wire
