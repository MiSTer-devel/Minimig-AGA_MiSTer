...
static size_t
format_int(char *q, size_t n, unsigned int val, enum flags flags,
	   int base, int width, int prec)
{
	...
	if (flags & FL_SIGNED && (unsigned int) val < 0) {
		minus = 1;
		val = (unsigned int) (-(unsigned int) val);
	}
