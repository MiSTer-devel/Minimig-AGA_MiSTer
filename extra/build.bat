...
copy SHARE DEVS\DOSDrivers\SHARE >nul
copy SHARE.info DEVS\DOSDrivers\SHARE.info >nul
...
lhant -a MiSTer_share.lha L\MiSTerFileSystem DEVS\dummy.device DEVS\MountList DEVS\DOSDrivers\SHARE DEVS\DOSDrivers\SHARE.info
